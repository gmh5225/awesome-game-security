...
- [DMA Attack](overviews/dma-attack.md) — PCIe DMA threat model (cheat PC + FPGA + HID); three defense layers; firmware tiers 0–6; layered detection + TPM attestation; Cheat (~2657) / Detection:DMA (~648) + WSF PCR
...
- Projected category map: `sources/README-categories.md` (generated on scan; 41 top-level sections; NeverC & NeverD placeholder; Game Engine ~155 / Renderer ~17 / Cheat ~2657 / Anti Cheat ~648 / DirectX ~37 shader inject+flatten / Vulkan ~11 kiero2+vocem / Game Develop ~183 / Game Network ~26 / Game CI ~3 Epic lore / Image Codec ~5 [[paintfe]] / Xbox ~8 / PlayStation ~7 / Nintendo 3DS ~3 3Beans LLE / GameCube/Wii ~1 gecko)
