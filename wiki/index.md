...
- [Overview](overviews/overview.md) — project map; 40 README sections → skill topics (Cheat ~2593 / Anti Cheat ~616; Game Engine ~149 + Mathematics ~7 / Renderer ~17; DirectX ~34 / OpenGL ~3 / Vulkan ~9; Game Develop ~182 MCP/security; Game Network ~26; console Switch~7/Xbox~7/PS~7 + 3DS/GC·Wii)
...
- [DMA Attack](overviews/dma-attack.md) — PCIe DMA via Cheat (~2593) / Detection:DMA (~616) + WSF attestation
...
- [Game Hacking](overviews/game-hacking.md) — Cheat taxonomy (~2593) + Some Tricks (~113); Android Terminal (ADB/root/shell)/File/Memory Explorer; WSA/Android/iOS/Windows Emulator lanes; console PS HV+BD-JB / WebKit CSSFontFace / PSFree / 3DS LLE / GC·Wii
...
- [Reverse Engineering](overviews/reverse-engineering.md) — RE tools (file-format/asset lists + Ghidra managers), MBA/DBI, deobfuscation, packers; Windows Emulator + console/PS BD-JB+WebKit/PSFree / 3DS/GC·Wii RE (~2593 Cheat / ~616 AC lanes)
...
- Projected category map: `sources/README-categories.md` (generated on scan; 40 top-level sections; Game Engine ~149 / Renderer ~17 / Cheat ~2593 / Anti Cheat ~616 / DirectX ~34 / Game Develop ~182 / Game Network ~26 / PlayStation ~7)
