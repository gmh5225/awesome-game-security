...
- [dsh-plugins](entities/dsh-plugins.md) — DSH plugin bundle: PyGhidra Ghidra bridge (binary import/decompile/strings/xrefs) + radare2/RetDec/tshark forensics + agent bridges; AI-assisted malware/game-binary RE (GalaxyBatMan111; Cheat / RE Tools)
