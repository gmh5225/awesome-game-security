...
- [Overview](overviews/overview.md) — project map; 40 README sections → skill topics (Cheat ~2592 / Anti Cheat ~614; Game Engine ~149 + Mathematics ~7 / Renderer ~17; Game Develop ~182 MCP/security; Game Network ~26; console Switch~7/Xbox~7/PS~7 + 3DS/GC·Wii)
- [Anti-Cheat](overviews/anti-cheat.md) — layered AC; Detection:* (triggerbot & aimbot/wallhack) + page/CLR protection (~614); hybrid OS AC; Game Tools RCE + Windows Emulator AC
- [DMA Attack](overviews/dma-attack.md) — PCIe DMA via Cheat (~2592) / Detection:DMA (~614) + WSF attestation
...
- [Game Hacking](overviews/game-hacking.md) — Cheat taxonomy (~2592) + Some Tricks (~113); Android Terminal (ADB/root/shell)/File/Memory Explorer; console PS HV+BD-JB / WebKit CSSFontFace / PSFree / 3DS LLE / GC·Wii
...
- [Reverse Engineering](overviews/reverse-engineering.md) — RE tools (file-format/asset lists + Ghidra managers), MBA/DBI, deobfuscation, packers; Windows Emulator + console/PS BD-JB+WebKit/PSFree / 3DS/GC·Wii RE (~2592 Cheat lane)
...
- Projected category map: `sources/README-categories.md` (generated on scan; 40 top-level sections; Game Engine ~149 / Renderer ~17 / Cheat ~2592 / Anti Cheat ~614 / DirectX ~34 / Game Develop ~182 / Game Network ~26 / PlayStation ~7)
