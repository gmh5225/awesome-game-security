...
- [HOOZi CS2 DMA](entities/hoozi-cs2-dma.md) — CS2 external read-only FPGA DMA ESP (orphannn; boxes/skeletons/health/armor/name/weapon/distance; map-collision visibility for 21 maps; pattern scan + Source 2 schema offset sync; LeechCore/VMM; cheat / game:cs2 [DMA])
