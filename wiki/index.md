...
- [DMA Attack](overviews/dma-attack.md) — PCIe DMA threat model (cheat PC + FPGA + HID); three defense layers; firmware tiers 0–6; layered detection + TPM attestation; Cheat (~2689) / Detection:DMA (~663) + WSF PCR
...
- [Killer](entities/killer.md) — kernel driver process terminator via kernel process-structure manipulation (protected AC/EDR/AV; Killer-Exercice RE lab; gmh5225)
...
- Projected category map: `sources/README-categories.md` (generated on scan; 41 top-level sections; NeverC & NeverD — Your Compiler & Decoder for the AI Era placeholder; Game Engine ~155 / Renderer ~17 / Cheat ~2689 / Anti Cheat ~663 / DirectX ~38 shader inject+flatten / Vulkan ~11 kiero2+vocem / Game Develop ~183 / Game Network ~27 ds2os/ds3os / Game CI ~3 Epic lore / Image Codec ~5 [[paintfe]] / Xbox ~8 / PlayStation ~7 / Nintendo 3DS ~3 3Beans LLE / GameCube/Wii ~1 gecko)
