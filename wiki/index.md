...
- [Overview](overviews/overview.md) — project map; 40 README sections → skill topics (Cheat ~2582 / Anti Cheat ~610; Game Engine ~147 + Mathematics ~7 / Renderer ~17; Game Develop ~181 MCP/security; Game Network ~26; console Switch/Xbox/PS + 3DS/GC·Wii)
- [Anti-Cheat](overviews/anti-cheat.md) — layered AC; Detection:* (triggerbot & aimbot/wallhack) + page/CLR protection (~610); hybrid OS AC; Game Tools RCE + Windows Emulator AC
- [DMA Attack](overviews/dma-attack.md) — PCIe DMA via Cheat (~2582) / Detection:DMA (~610) + WSF attestation
- [Game Engine](overviews/game-engine.md) — Unreal / Unity / Source / Godot / Lumix (~147); Mathematics/PhysX/Renderer (~17) adjacency; MCP server/security + AI gamedev (~181); Game Network ~26; Image Codec + Manager/Testing/Tools/CI
...
- Projected category map: `sources/README-categories.md` (generated on scan; 40 top-level sections; Game Engine ~147 / Renderer ~17 / Cheat ~2582 / Anti Cheat ~610 / DirectX ~34 / Game Develop ~181 / Game Network ~26)
