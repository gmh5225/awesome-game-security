...
- [Detector Operations](concepts/detector-operations.md) — health/evidence/execution/decision state separation, time domains, shadow/canary rollout, collector health vs misconduct, joint error measurement
