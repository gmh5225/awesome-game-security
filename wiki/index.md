...
- [Overview](overviews/overview.md) — project map; compiled-wiki + research-rigor layers; 41 README sections (NeverC & NeverD placeholder) → skill topics (Cheat ~2662 / Anti Cheat ~655; Game Engine ~155 + Mathematics ~7 / Renderer ~17 ReShade; DirectX ~37 shader inject/flatten / OpenGL ~3 / Vulkan ~11 kiero2+vocem; Game Develop ~183 MCP/security; Game Network ~26; console Switch~8 OpenSw/Xbox~8/PS~7 BD-UN-JB+PSFree-Enhanced / 3DS~3 3Beans LLE+Luma / GC·Wii~1 gecko / Game Boy ~3)
- [Anti-Cheat](overviews/anti-cheat.md) — layered AC; detection methodology + [[kernel-pool-scanning]] / [[ai-aimbot-detection]]; Detection:* (triggerbot & aimbot/wallhack) + Screenshot + page/CLR protection (~655); hybrid CS2 judge/honeypot proposals + Minecraft anticheat catalog + AC research index + [[kernel-cve-analysis]]; Game Testing uptime signals; Game Tools RCE + Windows Emulator KDemu AC
- [DMA Attack](overviews/dma-attack.md) — PCIe DMA threat model (cheat PC + FPGA + HID); three defense layers; firmware tiers 0–6; layered detection + TPM attestation; Cheat (~2662) / Detection:DMA (~655) + WSF PCR
...
- Projected category map: `sources/README-categories.md` (generated on scan; 41 top-level sections; NeverC & NeverD placeholder; Game Engine ~155 / Renderer ~17 / Cheat ~2662 / Anti Cheat ~655 / DirectX ~37 shader inject+flatten / Vulkan ~11 kiero2+vocem / Game Develop ~183 / Game Network ~26 / Game CI ~3 Epic lore / Image Codec ~5 [[paintfe]] / Xbox ~8 / PlayStation ~7 / Nintendo 3DS ~3 3Beans LLE / GameCube/Wii ~1 gecko)
