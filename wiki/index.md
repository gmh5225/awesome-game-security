...
- [cs2-overwatch](entities/cs2-overwatch.md) — offline CS2 demo review pipeline (magicnothief; Python; aim/behavior models, ray-cast visibility, calibrated suspicion scoring, optional local LLM summaries; Anti Cheat / Analysis Framework)
...
- [Sentinel AntiCheat (Chess)](entities/sentinel-anticheat-chess.md) — chess integrity platform with seven-layer engine-assistance detection, explainable risk tiers, arbiter case management, and hash-chained audit logging (AbdulAmi09; Anti Cheat / Open Source Anti Cheat System)
