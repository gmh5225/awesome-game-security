...
- [Frida](concepts/frida.md) — injected/embedded/preloaded observation limits; integration modes vs stealth tiers; embedded Frida Gum in [[com-fuck-iab]] LSPosed IAP module; Stalker dual-trace branch divergence via [[veridiff]]; mobile instrumentation evidence table; [[overviews/mobile-security]] topic-routing cross-link
...
- [IL2CPP](concepts/il2cpp.md) — Unity AOT backend; metadata vs native trust boundary (stripping/AOT limits); Il2CppDomain hierarchy; metadata + dumpers (incl. metadata locator + Qiling emulation)
...
- [terraria-android-modding](entities/terraria-android-modding.md) — Android Terraria IL2CPP modding skill + Frida/JsHook injectable mod menu (il2cpp-by-name hooks, system-UI overlay, offline icon extraction; abcd123rft; Cheat / Frida)
