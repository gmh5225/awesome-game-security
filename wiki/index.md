...
- [Windows Kernel](overviews/windows-kernel.md) — [[driver-trust-boundaries]] IOCTL/provenance threat model + documented/observed/inferred evidence layers; VBS/HVCI capability vs running state; hypervisor/WHP + pool forensics limits; callbacks, CET/TPM attestation (~10; [[sewindows]] PCR + [[windows-runtime-attestation-report]]), BYOVD, Segment Heap + [[kernel-pool-scanning]] / [[etw-threat-intelligence]]; symbol walking; Some Tricks Ring0 (~118) + [[discord-dpi-bridge]] Ring3; Windows Emulator (~7) + WSL (~4)
...
- [Driver Trust Boundaries](concepts/driver-trust-boundaries.md) — IOCTL authorization, driver provenance, signed-driver threat classes; VBS/HVCI/blocklist scope; documented vs observed vs inferred kernel evidence
...
- [Kernel Pool Scanning](concepts/kernel-pool-scanning.md) — Segment Heap pool walks; Pool2/3 contract limits; pool-tag attribution vs proof; PiDDBCache/MmUnloadedDrivers exact-build evidence; KDP Secure Pool scope
