...
- [DMA Attack](overviews/dma-attack.md) — [[memory-acquisition-path]] initiator/transport classification; PCIe DMA threat model (cheat PC + FPGA + HID); three defense layers + assurance boundaries; device evidence dimensions; layered detection + TPM attestation; Thunderbolt/USB4; Cheat (~2800) / Detection:DMA (~719) + [[aetheris]]/[[luminary-dma]] MemProcFS forensics + WSF ~10 [[windows-runtime-attestation-report]]
