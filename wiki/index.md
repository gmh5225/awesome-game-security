...
- [PCILeechGen](entities/pcileechgen.md) — Go donor-cloning firmware generator (Linux VFIO/IOMMU → SystemVerilog/COE → Vivado bitstreams; NVMe/MSI-X/BAR profiling; PCILeech FPGA)
