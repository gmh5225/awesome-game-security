...
- [Overview](overviews/overview.md) — project map; 40 README sections → skill topics (Cheat ~2561 / Anti Cheat ~600; Game Engine ~143 + Mathematics ~7 / Renderer ~17; Game Develop ~177 MCP/security; Game Network ~26; console Switch/Xbox/PS + 3DS/GC·Wii)
- [Anti-Cheat](overviews/anti-cheat.md) — layered AC; Detection:* (triggerbot & aimbot/wallhack) + page/CLR protection (~600); hybrid OS AC; Game Tools RCE + Windows Emulator AC
- [DMA Attack](overviews/dma-attack.md) — PCIe DMA via Cheat (~2561) / Detection:DMA (~600) + WSF attestation
- [Game Engine](overviews/game-engine.md) — Unreal / Unity / Source / Godot / Lumix (~143); Mathematics/PhysX/Renderer (~17) adjacency; MCP server/security + AI gamedev (~177); Game Network ~26; Image Codec + Manager/Testing/Tools/CI
- [Game Hacking](overviews/game-hacking.md) — Cheat taxonomy (~2561) + Some Tricks (~113); Android Terminal/File/Memory Explorer; console PS HV+BD-JB RemoteJarLoader / 3DS LLE / GC·Wii
...
- [Reverse Engineering](overviews/reverse-engineering.md) — RE tools, MBA/DBI, deobfuscation, packers; Windows Emulator + console/PS BD-JB RemoteJarLoader / 3DS/GC·Wii RE (~2561 Cheat lane)
...
- Projected category map: `sources/README-categories.md` (generated on scan; 40 top-level sections; Game Engine ~143 / Renderer ~17 / Cheat ~2561 / Anti Cheat ~600 / Game Network ~26)
