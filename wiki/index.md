...
- [DMA Attack](overviews/dma-attack.md) — PCIe DMA threat model (cheat PC + FPGA + HID); three defense layers; firmware tiers 0–6; layered detection + TPM attestation; Cheat (~2773) / Detection:DMA (~704) + [[aetheris]]/[[luminary-dma]] MemProcFS forensics + WSF ~10 [[windows-runtime-attestation-report]]
...
- Projected category map: `sources/README-categories.md` (generated on scan; 41 top-level sections; NeverC & NeverD — Your Compiler & Decoder for the AI Era placeholder; Game Engine ~157 / Renderer ~17 / Cheat ~2773 [[dragonburn]]/[[apexbot]]/[[apexdream]]/[[astronaut00-apex-external]]/[[binarylens]]/[[aetheris]]/[[resim-ghidra-plugins]]/[[anti-anti-debugger-driver]]/[[zamr]] / Anti Cheat (~704) [[blc-gamesec-lab]] [[noimportz]]+Free-RASP-Community/[[obfstr]] / [[anti-cheat-emulator]]/[[ff-ace-anticheat-analysis]] / DirectX ~39 shader inject+[[segcap]] / Vulkan ~11 kiero2+vocem / Game Develop ~188 [[awesome-game-analysis]] / Game Network ~29 lightyear/ds2os/ds3os / Game CI ~3 Epic lore / Image Codec ~5 [[paintfe]] / Windows Security Features ~10 [[windows-runtime-attestation-report]] / IOS Emulator ~4 [[darwin-vm]] / Xbox ~8 / PlayStation ~7 / Nintendo 3DS ~3 [[3beans]] LLE / GameCube/Wii ~1 gecko)
