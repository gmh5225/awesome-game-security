...
- [guard-game](entities/guard-game.md) — Node.js engine-agnostic server-side AC (world-profile movement/action validation; speed/jump/teleport/fly/hover, packet flood, timestamp spoofing, item/quest abuse; strike ladder; TCP JSON + HTTP ingest; optional HMAC; Unity/Godot/Roblox/JS SDKs; Docker; Parko-Developer; Anti Cheat / Open Source Anti Cheat System)
