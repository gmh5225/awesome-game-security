...
- [Overview](overviews/overview.md) — project map; 40 README sections → skill topics (Cheat ~2572 / Anti Cheat ~607; Game Engine ~144 + Mathematics ~7 / Renderer ~17; Game Develop ~179 MCP/security; Game Network ~26; console Switch/Xbox/PS + 3DS/GC·Wii)
...
- [DMA Attack](overviews/dma-attack.md) — PCIe DMA via Cheat (~2572) / Detection:DMA (~607) + WSF attestation
...
- [Game Hacking](overviews/game-hacking.md) — Cheat taxonomy (~2572) + Some Tricks (~113); Android Terminal (ADB/root/shell)/File/Memory Explorer; console PS HV+BD-JB RemoteJarLoader / 3DS LLE / GC·Wii
...
- [Reverse Engineering](overviews/reverse-engineering.md) — RE tools (file-format/asset lists + Ghidra managers), MBA/DBI, deobfuscation, packers; Windows Emulator + console/PS BD-JB RemoteJarLoader / 3DS/GC·Wii RE (~2572 Cheat lane)
...
- Projected category map: `sources/README-categories.md` (generated on scan; 40 top-level sections; Game Engine ~144 / Renderer ~17 / Cheat ~2572 / Anti Cheat ~607 / DirectX ~34 / Game Develop ~179 / Game Network ~26)
