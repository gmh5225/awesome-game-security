...
- [windows-runtime-attestation-report](entities/windows-runtime-attestation-report.md) — C++ GetRuntimeAttestationReport sample (signed driver + kernel hotpatch runtime reports; VBS/HVCI; x64/ARM64; Windows Security Features; CodeMaxx)
