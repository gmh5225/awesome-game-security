...
- [Anti-Cheat](overviews/anti-cheat.md) — layered AC; detection methodology + [[kernel-pool-scanning]] / [[ai-aimbot-detection]]; Detection:* (triggerbot & aimbot/wallhack) + Screenshot + page/CLR protection (~692); hybrid CS2 judge/honeypot proposals + [[rce-shield]] RCE guide + [[minecraft-anticheat-list]] + [[astrox-anticheat]] GeyserMC Bedrock RakNet AC + [[inertia]] version-neutral MC foundation + AreWeAntiCheatYet Proton/Wine + AC research index + [[kernel-cve-analysis]]; Game Testing [[uptime-faker]] uptime signals; Game Tools RCE + Windows Emulator [[kdemu]] AC
