...
- [Driver Communication](concepts/driver-communication.md) — kernel–user data channels (IOCTL, data-ptr swap, shared memory, callbacks, unconventional transports); README 40+ method taxonomy
