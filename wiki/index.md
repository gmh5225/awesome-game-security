...
- [Frida](concepts/frida.md) — injected/embedded/preloaded observation limits; integration modes vs stealth tiers; mobile instrumentation evidence table
...
- [Mobile Anti-Cheat](concepts/mobile-anti-cheat.md) — mobile root/Frida/emulator/integrity/USB-ADB detection; ACE/RASP SDKs; G-Presto native AC RE; detection-finding review + [[mobile-trust-boundaries]] boundary attribution; post-clear identity rotation via [[device-reset-spoofer]]; in-app USB/ADB masking via [[usb-detection-bypass]]; MIUI/HyperOS vendor USB gate bypass via [[xiaomi-usb-security-bypass]]; bypass research framing
- [Mobile Trust Boundaries](concepts/mobile-trust-boundaries.md) — package/signing vs runtime vs platform integrity vs server authorization; SELinux/Play Integrity/App Attest/network-trust evidence; privilege/instrumentation limits; evidence-report fields
