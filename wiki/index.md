...
- [Anti-Screenshot Capture](concepts/anti-screenshot-capture.md) — capture-layer contracts (PrintWindow/DDA/Present/readback); WDA/FindClosestMatchingMode exclusion limits; AC BitBlt vs overlay evasion (DWM, frame suppress)
