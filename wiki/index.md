...
- [Research Rigor](concepts/research-rigor.md) — evidence discipline; evidence reconciliation across generated layers; pair with domain overviews
...
- [Are We Anti-Cheat Yet](entities/are-we-anti-cheat-yet.md) — crowd-sourced GNU/Linux/Proton/Wine AC compatibility tracker (JSON catalog; Next.js static site; readiness statuses; EAC/BattlEye listing; table/card/game pages + RSS; TypeScript/React/Mantine; Steam Deck reference)
