...
- [Overview](overviews/overview.md) — project map; compiled-wiki + research-rigor layers; 40 README sections → skill topics (Cheat ~2609 / Anti Cheat ~623; Game Engine ~154 + Mathematics ~7 / Renderer ~17; DirectX ~35 shader inject/flatten / OpenGL ~3 / Vulkan ~10 kiero2; Game Develop ~182 MCP/security; Game Network ~26; console Switch~7/Xbox~8/PS~7 BD-UN-JB+PSFree-Enhanced / 3DS~3 3Beans LLE+Luma / GC·Wii~1 gecko / Game Boy ~3)
...
- Projected category map: `sources/README-categories.md` (generated on scan; 40 top-level sections; Game Engine ~154 / Renderer ~17 / Cheat ~2609 / Anti Cheat ~623 / DirectX ~35 shader inject+flatten / Vulkan ~10 kiero2 / Game Develop ~182 / Game Network ~26 / Xbox ~8 / PlayStation ~7 / Nintendo 3DS ~3 3Beans LLE / GameCube/Wii ~1 gecko)
