...
- [UsbDetectionBypass](entities/usb-detection-bypass.md) — LSPosed/Xposed module masking in-app USB connection and USB debugging detection (SystemProperties, UsbManager, broadcasts, getprop/dumpsys, sysfs; Kotlin + native C++; RytterMohn; Cheat / Xposed)
