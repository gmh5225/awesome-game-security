...
- [Overview](overviews/overview.md) — project map; 40 README sections → skill topics (Cheat ~2592 / Anti Cheat ~613; Game Engine ~149 + Mathematics ~7 / Renderer ~17; Game Develop ~182 MCP/security; Game Network ~26; console Switch~7/Xbox~7/PS~7 + 3DS/GC·Wii)
...
- [DMA Attack](overviews/dma-attack.md) — PCIe DMA via Cheat (~2592) / Detection:DMA (~613) + WSF attestation
...
- Projected category map: `sources/README-categories.md` (generated on scan; 40 top-level sections; Game Engine ~149 / Renderer ~17 / Cheat ~2592 / Anti Cheat ~613 / DirectX ~34 / Game Develop ~182 / Game Network ~26 / PlayStation ~7)
