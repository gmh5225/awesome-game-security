...
- [Scalpel](entities/scalpel.md) — dockable dark-mode Ghidra hex/ASCII editor (Java 21/Swing; Listing-synced cursor; wildcard hex/UTF-8 search; inline transaction patching; ntdlll; cheat / Ghidra Plugins)
