...
- [BloxDesk](entities/bloxdesk.md) — Roblox Luau passive telemetry SDK (4Hz speed/fly/noclip/remote-spam detection; webhook incident reporting; Discord moderation + Gemini appeal triage + Open Cloud cross-server bans; Buck3ttcode; Anti Cheat / game:roblox)
