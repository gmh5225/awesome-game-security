...
- [Frida](concepts/frida.md) — injected/embedded/preloaded observation limits; integration modes vs stealth tiers; embedded Frida Gum in [[com-fuck-iab]] LSPosed IAP module; mobile instrumentation evidence table; [[overviews/mobile-security]] topic-routing cross-link
...
- [veridiff](entities/veridiff.md) — Frida Stalker dual-trace branch-divergence engine; Python + Rust; LCP basic-block diff + Capstone disassembly; OLLVM CFF resync; license/anti-cheat branch pinpointing (Veridiff; Cheat / Frida / DBI)
