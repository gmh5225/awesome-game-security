...
- [Reverse Engineering](overviews/reverse-engineering.md) — RE tools, MBA/DBI, deobfuscation, packers; Windows Emulator + console/PS BD-JB RemoteJarLoader / 3DS/GC·Wii RE (~2562 Cheat lane)
