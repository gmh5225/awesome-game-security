...
- [ida-plugin-repository](entities/ida-plugin-repository.md) — Official Hex-Rays JSON manifest + sync pipeline for plugins.hex-rays.com and IDA Plugin Manager (HexRaysSA; cheat / IDA Plugins)
