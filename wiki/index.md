...
- [Engine Trust Boundaries](concepts/engine-trust-boundaries.md) — reflected metadata vs native execution, assets, plugins, replication; baseline dimensions; evidence report fields; route authority/supply-chain/server time to dedicated skills
...
- [Unreal Object Model](concepts/unreal-object-model.md) — UObject hierarchy; reflection vs native layout; GObjects/GNames/GWorld; [[dumper-7]] SDK workflow
