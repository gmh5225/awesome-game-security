...
- [Detector Operations](concepts/detector-operations.md) — health/evidence/execution/decision state separation, time domains, shadow/canary rollout, collector health vs misconduct, joint error measurement; [[sac-the-server-anticheat]] CS2 progressive warning/ban + mass-check sensitivity; [[cs2-anticheat-by-chmonya]] decaying suspicion auto-ban
