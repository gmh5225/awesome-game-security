...
- [xrefgen](entities/xrefgen.md) — IDA Pro plugin: indirect/complex control-flow xref generator with XRefer-compatible output (data-flow taint, call-graph, CFF detection; x86/x64/ARM/ARM64/MIPS/WASM; seifreed; cheat / IDA Plugins)
