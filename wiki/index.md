...
- [Assurance Boundaries](concepts/assurance-boundaries.md) — mechanism vs deployed policy vs evidence coverage vs attribution; device-label limits; EPT vs IOMMU separation; HVCI/DMA-policy independence; TPM quote scope; PCI containment ownership
...
- [IOMMU](concepts/iommu.md) — VT-d/AMD-Vi translation; six out-of-domain paths; ACS/ATS-untrusted/RMRR; 16-entry bypass catalog + containment; enforcement vs observation limits via [[assurance-boundaries]]
