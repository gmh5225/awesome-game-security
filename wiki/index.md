...
- [Windows Kernel](overviews/windows-kernel.md) — callbacks, VBS/HVCI/CET/TPM attestation (~10; [[sewindows]] PCR + [[windows-runtime-attestation-report]] GetRuntimeAttestationReport), BYOVD, Segment Heap pool + [[kernel-pool-scanning]] / [[etw-threat-intelligence]]; symbol walking; Some Tricks Ring0 (~118) + [[discord-dpi-bridge]] Ring3; Windows Emulator (~7) + WSL (~4; [[wsl]] / [[wsl2-linux-kernel]] / [[wsl2-linux-kernel-rolling]] / [[windows-subsystem-linux]])
...
- [HVCI](concepts/hvci.md) — VBS VTL0/VTL1 Memory Integrity; W→X kernel code enforcement via hypervisor EPT/SLAT; [[windows-runtime-attestation-report]] GetRuntimeAttestationReport runtime driver/hotpatch inspection
