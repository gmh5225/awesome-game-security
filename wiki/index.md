...
- [Overview](overviews/overview.md) — project map; compiled-wiki + research-rigor layers; 41 README sections (NeverC & NeverD — Your Compiler & Decoder for the AI Era placeholder) → skill topics (Cheat ~2769 [[dragonburn]]/[[apexbot]]/[[apexdream]]/[[astronaut00-apex-external]] + [[perfectsmbios]] EFI/HWID + [[glotus-client]]/[[hidemyandroid]]/[[toastylink]]/[[vmplift]]/[[pc-wackywheels-doc]] + [[ida-settings]]/[[binarylens]]/[[aetheris]]/[[resim-ghidra-plugins]]/[[anti-anti-debugger-driver]] / Anti Cheat ~703 [[blc-gamesec-lab]] [[noimportz]]/[[free-rasp-community]]/[[obfstr]] + [[sentinel-anti-cheat]]/[[astrox-anticheat]]/[[blarion-anticheat]]/[[inertia]]/[[anticheat-qa]] + [[sentinel-anticheat-neoforge]] + [[amethyst]]/[[bs-anticheat]]/[[dead-anticheat]] MC/FiveM server-side AC; Game Engine ~156 + Mathematics ~7 / Renderer ~17 ReShade; DirectX ~39 shader inject/[[segcap]] / OpenGL ~3 / Vulkan ~11 kiero2+vocem; Game Develop ~188 [[awesome-game-analysis]]/MCP/security; Game Network ~29 lightyear/ds2os/ds3os; console Switch~8 OpenSw/Xbox~8/PS~7 [[bd-un-jb]]+[[psfree-enhanced]] / 3DS~3 [[3beans]] LLE+Luma / GC·Wii~1 gecko / Game Boy ~4 [[openfpga-gbc-cheats-ui]] / IOS Emulator ~4 [[darwin-vm]])
- [Anti-Cheat](overviews/anti-cheat.md) — layered AC; detection methodology + [[kernel-pool-scanning]] / [[ai-aimbot-detection]] / [[qortroller]] controller attestation; platform trust incl. [[windows-runtime-attestation-report]] GetRuntimeAttestationReport driver/hotpatch reports; Detection:* (triggerbot & aimbot/wallhack) + Screenshot + page/CLR protection (~703) + [[blc-gamesec-lab]] Analysis Framework; hybrid CS2 judge/honeypot proposals + [[rce-shield]] RCE guide + [[minecraft-anticheat-list]] + [[noimportz]] kernel zero-IAT lazy importer + [[obfstr]] Rust string crypter + [[sentinel-anti-cheat]] usermode daemon + [[sentinel-anticheat-neoforge]] NeoForge server-side MC mod + [[amethyst]] Bedrock prediction AC + [[bs-anticheat]] Paper/Folia heuristic AC + [[dead-anticheat]] FiveM server-side Lua AC + [[astrox-anticheat]] GeyserMC Bedrock RakNet AC + [[blarion-anticheat]] Bedrock ScriptAPI behavior-pack AC + [[inertia]] version-neutral MC foundation + [[anticheat-qa]] Fabric MC AC QA + [[are-we-anti-cheat-yet]] Proton/Wine/Linux + AC research index + [[kernel-cve-analysis]]; Game Testing [[uptime-faker]] uptime signals; Game Tools RCE + Windows Emulator [[kdemu]] AC
- [DMA Attack](overviews/dma-attack.md) — PCIe DMA threat model (cheat PC + FPGA + HID); three defense layers; firmware tiers 0–6; layered detection + TPM attestation; Cheat (~2769) / Detection:DMA (~703) + [[aetheris]] MemProcFS forensics + WSF ~10 [[windows-runtime-attestation-report]]
