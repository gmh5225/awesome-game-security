...
- [deREferencing](entities/dereferencing.md) — IDA Pro plugin: dereferenced register and stack debugger views with color-coded memory annotations (danigargu; Python; x86/ARM/MIPS; Cheat IDA Plugins)
