...
- [skid_factory](entities/skid-factory.md) — Node.js MCP orchestrator automating game RE and cheat dev via Cheat Engine, x64dbg, and Ghidra bridges; pointer-trace and memory-patch workflows (wrong-commit; Cheat / RE Tools)
