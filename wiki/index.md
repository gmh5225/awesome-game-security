...
- [Game Engine](overviews/game-engine.md) — Unreal / Unity / Source SDK workflows + [[unreal-object-model]] / [[unreal-engine-guide]] / [[il2cpp]] / [[source-netvars]]; Godot / Lumix (~156); Unity script/plugin catalogs ([[unity-script-collection]]); MCP + AI gamedev (~185; [[image-cockpit-for-codex-workflows]] Codex pixel-art cockpit); Game Network ~27 ds2os/ds3os; Game Assets ~11 ([[paksmith]], [[uassetgui]]/[[uassetapi]] + YAML→GLB/sprite pipelines); Image Codec ~5 ([[tigr]] framebuffer / [[paintfe]] wgpu/Rhai); Game CI ~3 (Epic lore VCS)
