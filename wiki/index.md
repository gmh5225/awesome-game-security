...
- [Mobile Security](overviews/mobile-security.md) — Android/iOS; root frameworks (Magisk/KernelSU/APatch), [[zygisk]]/Frida hooking (incl. [[frida-ide]] web IDE, [[grapefruit]] web UI, [[vscode-frida]] VS Code workbench, [[bagbak]] iOS IPA decrypt/dump, [[mast-orchestrator]] MAST dashboard), [[mobile-anti-cheat]]; Nai64Patches Morphe APK patches; [[ghostlock-oneplus]]/[[ghostlock-app]] CVE-2026-43499 root; [[kasumi]] GKI LKM root-hide; [[anywhere]] mock-GPS/LSPosed hide beside [[locusmimic]]; [[android-faker]] Xposed identifier spoof + [[nexus]] root device-identity rotation; Terminal/File/Memory/Network Explorer ([[butler]] root/Shizuku; [[charlyengine]] Kotlin CE clone; [[pcapdroid]]; [[rtl8852au-userspace]] no-root Wi-Fi inject) + App/Kernel CVE; WSA (~9), [[droidvm]]/Gunyah emulators, [[zn-toolbox]] no-root Twoyi container VM + LSPosed, IOS Emulator ~4 [[darwin-vm]]
