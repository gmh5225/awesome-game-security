...
- [Binary Diffing](concepts/binary-diffing.md) — BinDiff/[[diaphora]]/[[ghidriff]]/DarunGrim/[[turbodiff]] patch analysis; AC driver update tracking; similarity scores as candidate evidence; hash/tool-version/unmatched-function limits
- [Binary Evidence](concepts/binary-evidence.md) — question classification (interface abuse, integrity, obfuscation, anti-analysis, binary change); offset/RVA/runtime address provenance; imported API vs reachable path vs observed call; decompiler reconstruction limits
...
- [Dynamic Binary Instrumentation](concepts/dynamic-binary-instrumentation.md) — Frida/Pin/DynamoRIO/[[drmemory]]/[[tinyinst]]/[[river]]/[[mambo]]; trap-and-emulate CFT + semantic-fidelity/coverage/cost/scope evidence limits; WHP user-mode hypervisor tracing ([[vmtrace]]) + exit-reason/coverage limits; driver IOCTL tracing
