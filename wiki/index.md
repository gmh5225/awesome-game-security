...
- [Omikron TNS OMK Engine](entities/omikron-tns-omk-engine.md) — from-scratch C++20 Omikron: The Nomad Soul (1999) engine reimplementation; documented script VM/game-state/asset formats; Python verification suite; optional SDL/Vulkan (sosso33; Cheat / RE Tools)
