...
- [dragons-vs-vms](entities/dragons-vs-vms.md) — VMProtect x64 devirtualization lab (Fare9; dragon-tales symbolic handler analysis; all 256 handler slots classified; LLVM IR recovery; protected sample binaries with Binary Ninja databases; Cheat / Fix VMP)
