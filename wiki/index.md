...
- [Overview](overviews/overview.md) — project map; 40 README sections → skill topics (Cheat ~2561 / Anti Cheat ~601; Game Engine ~143 + Mathematics ~7 / Renderer ~17; Game Develop ~178 MCP/security; Game Network ~26; console Switch/Xbox/PS + 3DS/GC·Wii)
...
- [DMA Attack](overviews/dma-attack.md) — PCIe DMA via Cheat (~2561) / Detection:DMA (~601) + WSF attestation
...
- Projected category map: `sources/README-categories.md` (generated on scan; 40 top-level sections; Game Engine ~143 / Renderer ~17 / Cheat ~2561 / Anti Cheat ~601 / Game Network ~26)
