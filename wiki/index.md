...
- [Mobile Security](overviews/mobile-security.md) — Android/iOS; root frameworks (Magisk/KernelSU/APatch), [[zygisk]]/Frida hooking (incl. [[frida-ide]] web IDE), [[mobile-anti-cheat]]; Nai64Patches Morphe APK patches; [[anywhere]] mock-GPS/LSPosed hide beside [[locusmimic]]; Terminal/File/Memory Explorer ([[butler]] root/Shizuku) + App/Kernel CVE; WSA (~9), Droid-VM/Gunyah emulators
