...
- [Overview](overviews/overview.md) — project map; 40 README sections → skill topics (Cheat ~2563 / Anti Cheat ~603; Game Engine ~143 + Mathematics ~7 / Renderer ~17; Game Develop ~179 MCP/security; Game Network ~26; console Switch/Xbox/PS + 3DS/GC·Wii)
- [Anti-Cheat](overviews/anti-cheat.md) — layered AC; Detection:* (triggerbot & aimbot/wallhack) + page/CLR protection (~603); hybrid OS AC; Game Tools RCE + Windows Emulator AC
- [DMA Attack](overviews/dma-attack.md) — PCIe DMA via Cheat (~2563) / Detection:DMA (~603) + WSF attestation
...
- [Game Hacking](overviews/game-hacking.md) — Cheat taxonomy (~2563) + Some Tricks (~113); Android Terminal/File/Memory Explorer; console PS HV+BD-JB RemoteJarLoader / 3DS LLE / GC·Wii
...
- [Reverse Engineering](overviews/reverse-engineering.md) — RE tools, MBA/DBI, deobfuscation, packers; Windows Emulator + console/PS BD-JB RemoteJarLoader / 3DS/GC·Wii RE (~2563 Cheat lane)
...
- Projected category map: `sources/README-categories.md` (generated on scan; 40 top-level sections; Game Engine ~143 / Renderer ~17 / Cheat ~2563 / Anti Cheat ~603 / Game Develop ~179 / Game Network ~26)
