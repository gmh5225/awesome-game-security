...
- [Overview](overviews/overview.md) — project map; compiled-wiki + research-rigor layers; 41 README sections (NeverC & NeverD — Your Compiler & Decoder for the AI Era placeholder) → skill topics (Cheat ~2774 [[dragonburn]]/[[apexbot]]/[[apexdream]]/[[astronaut00-apex-external]] + [[perfectsmbios]] EFI/HWID + [[glotus-client]]/[[hidemyandroid]]/[[zamr]]/[[toastylink]]/[[vmplift]]/[[pc-wackywheels-doc]] + [[ida-settings]]/[[binarylens]]/[[sako-restudio]]/[[aetheris]]/[[resim-ghidra-plugins]]/[[anti-anti-debugger-driver]] / Anti Cheat (~704) [[blc-gamesec-lab]] [[noimportz]]/[[free-rasp-community]]/[[obfstr]] + [[anti-cheat-emulator]] + [[sentinel-anti-cheat]]/[[astrox-anticheat]]/[[blarion-anticheat]]/[[inertia]]/[[anticheat-qa]] + [[sentinel-anticheat-neoforge]] + [[amethyst]]/[[bs-anticheat]]/[[dead-anticheat]]/[[ff-ace-anticheat-analysis]] MC/FiveM server-side AC; Game Engine ~157 + Mathematics ~7 / Renderer ~17 ReShade; DirectX ~39 shader inject/[[segcap]] / OpenGL ~3 / Vulkan ~11 kiero2+vocem; Game Develop ~188 [[awesome-game-analysis]]/MCP/security; Game Network ~29 lightyear/ds2os/ds3os; console Switch~8 OpenSw/Xbox~8/PS~7 [[bd-un-jb]]+[[psfree-enhanced]] / 3DS~3 [[3beans]] LLE+Luma / GC·Wii~1 gecko / Game Boy ~4 [[openfpga-gbc-cheats-ui]] / IOS Emulator ~4 [[darwin-vm]])
- [Anti-Cheat](overviews/anti-cheat.md) — layered AC; detection methodology + [[kernel-pool-scanning]] / [[ai-aimbot-detection]] / [[qortroller]] controller attestation; platform trust incl. [[windows-runtime-attestation-report]] GetRuntimeAttestationReport driver/hotpatch reports; Detection:* (triggerbot & aimbot/wallhack) + Screenshot + page/CLR protection (~704) + [[blc-gamesec-lab]] Analysis Framework; hybrid CS2 judge/honeypot proposals + [[rce-shield]] RCE guide + [[minecraft-anticheat-list]] + [[noimportz]] kernel zero-IAT lazy importer + [[obfstr]] Rust string crypter + [[sentinel-anti-cheat]] usermode daemon + [[ultimate-anti-cheat]] open-source Windows AC framework + [[sentinel-anticheat-neoforge]] NeoForge server-side MC mod + [[amethyst]] Bedrock prediction AC + [[bs-anticheat]] Paper/Folia heuristic AC + [[dead-anticheat]] FiveM server-side Lua AC + [[astrox-anticheat]] GeyserMC Bedrock RakNet AC + [[blarion-anticheat]] Bedrock ScriptAPI behavior-pack AC + [[inertia]] version-neutral MC foundation + [[anticheat-qa]] Fabric MC AC QA + [[anti-cheat-emulator]] kernel telemetry simulation + [[are-we-anti-cheat-yet]] Proton/Wine/Linux + AC research index + [[kernel-cve-analysis]] + [[ff-ace-anticheat-analysis]] Tencent ACE Free Fire RE; Game Testing [[uptime-faker]] uptime signals; Game Tools RCE + Windows Emulator [[kdemu]] AC
- [DMA Attack](overviews/dma-attack.md) — PCIe DMA threat model (cheat PC + FPGA + HID); three defense layers; firmware tiers 0–6; layered detection + TPM attestation; Cheat (~2774) / Detection:DMA (~704) + [[aetheris]]/[[luminary-dma]] MemProcFS forensics + WSF ~10 [[windows-runtime-attestation-report]]
...
- Projected category map: `sources/README-categories.md` (generated on scan; 41 top-level sections; NeverC & NeverD — Your Compiler & Decoder for the AI Era placeholder; Game Engine ~157 / Renderer ~17 / Cheat ~2774 [[dragonburn]]/[[apexbot]]/[[apexdream]]/[[astronaut00-apex-external]]/[[binarylens]]/[[sako-restudio]]/[[aetheris]]/[[resim-ghidra-plugins]]/[[anti-anti-debugger-driver]]/[[zamr]] / Anti Cheat (~704) [[blc-gamesec-lab]] [[noimportz]]+Free-RASP-Community/[[obfstr]] / [[anti-cheat-emulator]]/[[ff-ace-anticheat-analysis]] / DirectX ~39 shader inject+[[segcap]] / Vulkan ~11 kiero2+vocem / Game Develop ~188 [[awesome-game-analysis]] / Game Network ~29 lightyear/ds2os/ds3os / Game CI ~3 Epic lore / Image Codec ~5 [[paintfe]] / Windows Security Features ~10 [[windows-runtime-attestation-report]] / IOS Emulator ~4 [[darwin-vm]] / Xbox ~8 / PlayStation ~7 / Nintendo 3DS ~3 [[3beans]] LLE / GameCube/Wii ~1 gecko)
