...
- [Frida](concepts/frida.md) — injected/embedded/preloaded observation limits; integration modes vs stealth tiers; mobile instrumentation evidence table; [[overviews/mobile-security]] topic-routing cross-link
...
- [com-fuck-iab](entities/com-fuck-iab.md) — FKIAB LSPosed/Xposed module; hooks Google Play/Bazaar/Myket in-app billing; Frida Gum per-package TypeScript scripts; restore purchases / bypass local IAP checks (Xposed-Modules-Repo; Cheat / Xposed; mobile IAP RE)
