...
- [Compiled Wiki](concepts/compiled-wiki.md) — four-layer discovery model (wiki → README → descriptions → archives); discovery aid, not proof
...
- [Resource Selection](concepts/resource-selection.md) — domain routing, provenance fields, data-layer order, README maintenance convention
