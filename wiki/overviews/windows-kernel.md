...
- **Offline memory forensics:** RAM-image frameworks such as [[volatility3]] (Python 3; plugin-based process/network/registry/kernel-object extraction; automagic OS profiles) support post-compromise kernel-state analysis without live attach. (source: wiki/sources/descriptions/volatilityfoundation__volatility3.md)
