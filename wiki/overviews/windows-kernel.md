...
- **OS LPE / sandbox escape:** first-party Windows LPE PoCs such as [[cve-2026-40369-exploit]] abuse `NtQuerySystemInformation` class 253 for arbitrary kernel address increment on Win11 24H2–25H2 (Chrome-sandbox reachable). (source: wiki/sources/descriptions/orinimron123__CVE-2026-40369-EXPLOIT.md)
