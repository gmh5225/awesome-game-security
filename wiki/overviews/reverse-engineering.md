...
- **Memory forensics (RAM):** frameworks such as [[volatility3]] (Python 3 rewrite; Win/Linux/macOS plugins; layer translation + automagic profiles) extract process/network/registry/kernel artifacts from offline memory images for IR and malware RE. (source: wiki/sources/descriptions/volatilityfoundation__volatility3.md)
