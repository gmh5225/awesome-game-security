...
- **Game engines:** [[il2cpp]] dumps, Unreal SDK generators, native PE/pattern workflows; Flutter/Dart AOT snapshot static analysis via [[unflutter]] (source: wiki/sources/descriptions/zboralski__unflutter.md); managed .NET 2D engine trees such as [[flatredball]] for inspecting a complete editor/runtime codebase (source: wiki/sources/descriptions/vchelaru__FlatRedBall.md); RPG Maker XP/VX/VX Ace encrypted-archive extraction via [[rpgmakerdecrypter]] (CLI; cheat / RE-tools lane) (source: wiki/sources/descriptions/uuksu__RPGMakerDecrypter.md)
