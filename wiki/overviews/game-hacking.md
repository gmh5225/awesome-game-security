...
- QQ Tang (QQ堂) title-specific Cheat Engine samples such as [[qqtang-cheat-engine]] (C++/C; memory scan/edit for Tencent’s casual game; cheat / game:qqtang [Cheat Engine]; gmh5225) sit in the Chinese casual-game CE lane beside generic scanners such as [[cheap-engine]]. (source: wiki/sources/descriptions/gmh5225__QQTangCheatEngine.md)
