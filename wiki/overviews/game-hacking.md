...
- PE triage of game/client modules (imports, TLS, .NET metadata) via viewers such as [[totalpe2]] before deeper RE. (source: wiki/sources/descriptions/zodiacon__TotalPE2.md) Authenticode signature steal/copy tooling such as [[sigthief]] (PE `certTable` transplant; weak AV CA/presence checks) sits in the Some Tricks / Windows Ring3 lane. (source: wiki/sources/descriptions/secretsquirrel__SigThief.md)
...
- Static-library function identification via [[idenlibx]] (idenLib x64dbg plugin; signature scan of loaded modules → live name apply) sits in the Cheat Library Function Identification / x64dbg Plugins lane. (source: wiki/sources/descriptions/secrary__idenLibX.md)
