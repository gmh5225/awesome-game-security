...
- Visual ESP / aim / movement cheats; AI visual pipelines (OBS + YOLO + HID); defensive ML counterparts such as [[waldo]] (CS2 deep-learning triggerbot/aimbot detection; user-trained model) (source: wiki/sources/descriptions/waldo-vision__waldo.md)
