...
- OoT3D Luma3DS `.3gx` cheat/tools overlay [[ocarina-ctr-composer]] (self-rendered CTRComposer UI; direct memory writes; cheat search / hex editor / RAM dump) sits in the console `Nintendo 3DS` lane. (source: wiki/sources/descriptions/samaBR85__OcarinaCTRComposer.md)
