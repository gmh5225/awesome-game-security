...
Present hooks ([[present-hook]]): D3D9/11/12, Vulkan `vkQueuePresentKHR`, OpenGL `wglSwapBuffers`; alternatives include DWM, transparent external windows, Steam/NVIDIA overlay hijacks ([[steam-overlay-x64]], [[mwclap]]). UI substrate: [[imgui]] and extensions ([[imgui-club]]).
