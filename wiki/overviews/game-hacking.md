...
- Palworld save / editor tooling such as [[palworldsaved]] (rendering + editor; UE5) sits in the cheat / game:palworld [Save] lane. (source: wiki/sources/descriptions/weizhking__PalworldSaved.md) Palworld modding kit samples such as [[palworld-modding-kit]] (modding kit; UE5; example usage) sit in the cheat / game:palworld [UE5] modding lane. (source: wiki/sources/descriptions/localcc__PalworldModdingKit.md) Adjacent title-specific AC research such as [[palworld-anti-cheat]] (C#; shader / rendering / audio; Anti Cheat) targets the same game:palworld [UE5] surface. (source: wiki/sources/descriptions/shalzuth__PalWorldAntiCheat.md) Dedicated-server RCON clients such as [[palworld-rcon]] (Source RCON protocol; kicks / bans / broadcasts / config; Server on Windows) sit in the adjacent server-admin lane for Palworld instances. (source: wiki/sources/descriptions/luciouskami__palworld_rcon.md)
