...
- Android Terminal Emulator lane: [[termux-app]] (Termux; no-root Linux env / pkg+apt / proot) and [[android-terminal-emulator]] (jackpal; VT-100 codes; built-in Android shell) for on-device CLI research. (source: wiki/sources/descriptions/termux__termux-app.md) (source: wiki/sources/descriptions/jackpal__Android-Terminal-Emulator.md)
...
- Desktop PUBG internal reference samples such as [[pubg-internal]] (iCollin; learning-oriented RE artifact; cheat / game:pubg) sit in the PC battle-royale offensive lane beside CV/trigger pipelines such as [[yolov5-pubg]]. (source: wiki/sources/descriptions/iCollin__pubg-internal.md)
...
- Free Counter-Strike 1.6 cheat samples such as [[oxware]] (C++; large alpha codebase; RE/offensive study) sit in the cheat / game:cs1.6 lane. (source: wiki/sources/descriptions/oxiKKK__oxware.md)
