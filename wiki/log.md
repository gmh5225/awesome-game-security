...
- **2026-08-24** — ingest `description:Ishanoshada/Ultimate-Frida-Bypass`: entity [[ultimate-frida-bypass]] (Ishanoshada; comprehensive Frida JS injection script; nineteen layered Java/native hooks; hide Frida presence; spoof device/debugger state; neutralize Talsec/freeRASP/PairIP; port/netstat detection, threat callbacks, SSL pinning, Crashlytics suppression, libc native scans; Talsec demo + RASP-protected Android targets; mobile RE / anti-cheat evaluation); cited on [[concepts/frida]] and [[overviews/mobile-security]]; cross-linked [[frida-detection-bypass]], [[anti-frida-bypass]], [[free-rasp-android]], and [[pairipcore]].

- **2026-08-24** — ingest `description:IvanMurzak/GameDev-MCP-Server`: entity [[gamedev-mcp-server]] (IvanMurzak; engine-agnostic C# ASP.NET Core MCP proxy host shared by Unity-MCP, Godot-MCP, and Unreal-MCP plugins; SignalR bridge to in-editor plugins; stdio/streamableHttp transports; OAuth, origin allow-listing, session handling; standalone/Docker/global .NET tool; AI agents control/inspect game engines via common local MCP endpoint; Game Develop / MCP); cited on [[overviews/game-engine]]; cross-linked [[unity-mcp]], [[unreal-mcp]], [[better-godot-mcp]], [[everything-game-dev-code]], and [[mcpup]].
...
- **2026-08-24** — ingest `description:JGonz1337/kernel-eac-be-comm`: entity [[kernel-eac-be-comm]] (JGonz1337; C++ kernel driver + user client; hooked win32k function pointer KM↔UM comm; custom request structures + XOR-obfuscated strings + compact control protocol; process/module lookup, memory R/W, alloc/free/protect; anti-cheat bypass + game memory tooling research; README `[NtGdiPolyPolyDraw]`); cited on [[overviews/windows-kernel]] and [[overviews/game-hacking]]; cross-linked [[kernel-eac-be-injector]], [[comm-data-ptr-driver]], [[interep-driver-leak]], [[data-communication]], [[km-um-communication]], [[easy-anti-cheat]], and [[battleye]].

- **2026-08-24** — ingest `description:JGonz1337/kernel-eac-be-injector`: entity [[kernel-eac-be-injector]] (JGonz1337; kernel-assisted manual-map DLL injector; kernel hook-based command handler + user-mode mapper; relocation/import/section write + remote DllMain; kernel memory alloc/exposure + pointer-swap hooks + mapped-payload cleanup; anti-cheat-resistant injection workflow research; PTE.User); cited on [[overviews/game-hacking]] and [[overviews/windows-kernel]]; cross-linked [[kernelmode-dll-injector]], [[face-injector-v2]], [[stealthy-kernelmode-injector]], [[memmap]], [[eac-injector-driver]], [[easy-anti-cheat]], and [[battleye]].
...
- **2026-08-24** — ingest `description:JOKOSAHS/DMA-Pcileech`: entity [[dma-pcileech]] (JOKOSAHS; open-source [[pcileech-fpga]] network-card-style firmware; SystemVerilog/Verilog + Vivado TCL/constraints; Screamer M2/Enigma X1/Squirrel/Artix-7; TLP handling, config-space shadow, BAR control, FT601 USB, FIFO/mux datapaths; TLP interrupt tuning; educational release after ACE network-card firmware detection; cheat / DMA); cited on [[overviews/dma-attack]] and [[concepts/dma]]; cross-linked [[pcileech]], [[pcileech-fpga]], [[pcileech-wifi]], [[pcileech-wifi-v2]], [[pcileechgen]], and [[dma-fw-guide-2.0]].
...
- **2026-08-24** — ingest `description:K3V1991/How-to-download-and-install-WSA`: entity [[how-to-download-and-install-wsa]] (K3V1991; step-by-step Win11 WSA manual install guide; Developer Mode + Virtual Machine Platform; dependency packages; Explorer/PowerShell bundle install; Cheat WSA / Guide); cited on [[overviews/mobile-security]] and [[overviews/game-hacking]]; cross-linked [[wsa-builds]], [[magiskonwsalocal]], [[wsapatch]], [[wsa-pacman]], and [[win11-apk-installer]].

- **2026-08-24** — ingest `description:K4ryuu/IDA-VTableExplorer`: entity [[ida-vtable-explorer]] (K4ryuu; C++ IDA Pro 9.x plugin; automates GCC/MSVC vtable detection, class extraction, virtual-function index/offset annotation; RTTI inheritance analysis, override comparison, hierarchy visualization; cheat / IDA Plugins); cited on [[overviews/reverse-engineering]] and [[overviews/game-hacking]]; cross-linked [[ida-vtable-tools]], [[ida-medigate]], [[classy]], [[classmaker]], [[pyclassinformer]], and [[ghidra-cpp-class-analyzer]].

- **2026-08-24** — ingest `description:KANKOSHEV/Detect-HiddenThread-via-KPRCB`: entity [[detect-hiddenthread-via-kprcb]] (KANKOSHEV; kernel PoC; detects hidden threads removed from process/thread ID table; walks KPRCB-related structures + thread lookup verification; Visual Studio C/C++ kernel driver; anti-cheat integrity monitoring / low-level forensic research); cited on [[overviews/windows-kernel]] and [[overviews/anti-cheat]]; cross-linked [[hidden-thread-finder]], [[unkover]], [[system-thread-finder]], [[stealth-sytem-thread-finder-be]], [[kernel-anti-cheat]], [[covert-thread]], and [[detect-keattachprocess]].

- **2026-08-24** — ingest `description:KANKOSHEV/Detect-KeAttachProcess`: entity [[detect-keattachprocess]] (KANKOSHEV; kernel research sample; KeAttachProcess usage detection; continuously running kernel driver; enumerates processes/threads and inspects thread context for unexpected attached target processes; Visual Studio C/C++; anti-cheat / covert process-attachment monitoring research); cited on [[overviews/windows-kernel]] and [[overviews/anti-cheat]]; cross-linked [[driver-kdtour]], [[ntmemory]], [[face-injector-v2]], [[detect-mouseclassservicecallback]], [[windows-kernel-rs]], and [[driver-read-write]].
...
- **2026-08-23** — ingest `description:KeServiceDescriptorTable/vulnerable-drivers`: entity [[vulnerable-drivers]] (KeServiceDescriptorTable; curated collection of vulnerable signed Windows kernel `.sys` binaries from multiple vendors; exploitable IOCTL interfaces, memory-access primitives, or other security weaknesses; BYOVD researchers, anti-cheat engineers, kernel security analysts; vulnerable-driver cataloging and exploitation-surface analysis; README Vulnerable drivers for windows machines); cited on [[concepts/byovd]] and [[overviews/windows-kernel]]; cross-linked [[loldrivers]], [[ms-vulnerable-driver-list]], [[drivers-and-shit]], and [[vulnerable-driver-scanner]].
...
- **2026-08-23** — ingest `description:Keyzp1337/Fortnite`: entity [[keyzp1337-fortnite]] (Keyzp1337; C++ x64 Visual Studio; internal cheat base; ESP/aimbot/no recoil + ImGui menu; BYO injection path; offset-dependent UE integration; cheat development + client internals RE; cheat / game:fortnite [Internal]; slug disambiguated from [[fortnite]]); cited on [[overviews/game-hacking]] and [[overviews/anti-cheat]]; cross-linked [[basic-fortnite-cheat-source-internal]], [[fortnite-cheat-source-internal]], [[fortnite-hack-esp-exploits-with-menu]], [[keyzpon-thefluxxx-fortnite-external]], [[unreal-object-model]], [[easy-anti-cheat]], and [[windows-dll-injector]].
...
- **2026-08-23** — ingest `description:Lazyzouo/ICUAC`: entity [[icuac]] (Lazyzouo; Java 21 Gradle Paper/Folia server-side rule enforcement; modular command/player-state/location/inventory/combat checks; blocked commands, tab-complete hiding, game-mode isolation, coordinate limits, death-drop control, banned materials, NBT/enchantment validation, stack/potion limits, end-crystal cooldowns; bilingual CN/EN; Folia-aware scheduling; SHA-256-verified GitHub updater; lightweight anti-abuse/integrity controls not full client AC; Anti Cheat / game:minecraft); cited on [[overviews/anti-cheat]] and [[overviews/game-hacking]]; cross-linked [[nocheatplus]], [[uagc]], [[minecraft-anticheat-list]], and [[minecraft-anti-cheat]].

- **2026-08-23** — ingest `description:Leeksov/rustsecure-re`: entity [[rustsecure-re]] (Leeksov; static RE of RustSecure client anti-cheat for Facepunch Rust; loader/encrypted payload/CLR bridge/Core DLL; 13 detection modules—anti-debug/VM, NT syscalls, HWID, BepInEx/kdmapper, screenshots, WebSocket telemetry; Python/C# decrypt/deobfuscate tooling; bypass write-ups; static-only ILSpy/dnfile/IDA; Anti Cheat / game:rust); cited on [[overviews/anti-cheat]] and [[overviews/reverse-engineering]]; cross-linked [[easy-anti-cheat]], [[kdmapper]], [[bepinex-il2cppbase]], [[il2cpp]], [[al-khaser]], [[lord-abbot-rust-external-cheat]], and [[rust-rustinternal]].
...
- **2026-08-23** — ingest `description:LloydLabs/ntqueueapcthreadex-ntdll-gadget-injection`: entity [[ntqueueapcthreadex-ntdll-gadget-injection]] (LloydLabs; C PoC; NtQueueApcThreadEx + random ntdll pop/ret gadgets so APC routine pointers appear module-backed; documents detection vectors; offensive tradecraft + AC/EDR APC-execution telemetry evaluation; README NtQueueApcThreadEx + gadget); cited on [[overviews/game-hacking]] and [[overviews/anti-cheat]]; cross-linked [[frankenstein-apc-injection]], [[stealth-apc-dispatcher]], [[process-injection-techniques]], [[windows-process-injection]], [[apc-research]], [[shellcode-plain-sight]], and [[wsb-detect]].

- **2026-08-23** — ingest `description:LloydLabs/shellcode-plain-sight`: entity [[shellcode-plain-sight]] (LloydLabs; C demo; oversized random-filled RW buffer, payload at random offset, VirtualProtect to RX, post-exec zero cleanup; evasion research + memory-analysis / AC detection testing against concealed payload placement; README Hiding shellcode in plain sight within a large memory region); cited on [[overviews/anti-cheat]] and [[overviews/game-hacking]]; cross-linked [[shellcode-fluctuation]], [[shellcode-entropyfix]], [[cfg-find-hidden-shellcode]], and [[rwxfinder]].
...
- **2026-08-23** — ingest `description:LooperSalty/cs2-tracker`: entity [[cs2-tracker]] (LooperSalty; Windows CS2 stats + live match tracker; Python FastAPI + SQLite + optional Qt/web UI; Steam Web API + Game State Integration only—no memory read/inject; ~30 explainable heuristic detectors; Bayesian 0–100 suspicion scoring; optional C++ live overlay; analyst/competitive-player transparency lane; game:cs2); cited on [[overviews/anti-cheat]] and [[overviews/game-hacking]]; cross-linked [[osanticheat]], [[cs2ac]], [[cs2-calladmin]], [[aimbot-detection-prototype]], and [[alibi]].
...
- **2026-08-23** — ingest `description:M3351AN/ZhangBing-Injector`: entity [[zhangbing-injector]] (M3351AN; C++ usermode BYOVD DLL injector; bundled WHQL-signed vulnerable `.sys` drivers; driver-mediated memory ops + protected-process injection; credits kdmapper; kernel-assisted injection / vulnerable-driver exploitation research); cited on [[overviews/windows-kernel]] and [[overviews/game-hacking]]; cross-linked [[kdmapper]], [[byovd]], [[kernelmode-dll-injector]], [[mminject]], [[present-injector]], and [[meme-rw]].
...
- **2026-08-23** — ingest `description:MKXJun/DirectX11-With-Windows-SDK`: entity [[directx11-with-windows-sdk]] (MKXJun; Windows SDK DirectX 11 tutorial + sample collection; progressive rendering + ImGui; CMake/VS builds; triangle through shadow mapping, deferred shading, compute shaders; graphics programmers learning DX11 pipeline programming; README `[DX11 zh]`; DirectX / guide); cited on [[overviews/graphics-api]] and [[overviews/game-engine]]; cross-linked [[cpp-3d-game-tutorial-series]], [[intro-to-dx11-revisited]], [[hw3d]], [[super-fighter]], [[rubik-cube]], and [[learn-directx]].

- **2026-08-23** — ingest `description:MKXJun/Rubik-Cube`: entity [[rubik-cube]] (MKXJun; Windows C++ DX9/DX11 3D Rubik's Cube; HLSL shaders; custom rendering, camera, and input; keyboard/mouse cube manipulation + timing; full source, assets, and release builds; developers learning real-time graphics and native DirectX game architecture; README `[DX9/11 Mini Game]`; Game Develop / source); cited on [[overviews/graphics-api]] and [[overviews/game-engine]]; cross-linked [[super-fighter]], [[cpp-3d-game-tutorial-series]], [[intro-to-dx11-revisited]], [[hw3d]], and [[learn-directx]].

- **2026-08-23** — ingest `description:MKXJun/Super-Fighter`: entity [[super-fighter]] (MKXJun; Windows C++ DX11 shoot-'em-up remake; Direct3D + HLSL shaders + DirectSound; configurable stage/enemy data, replay support, keyboard/Xbox controller input; arcade-style complete game loop; developers/students studying native Windows game programming; README `[DX11 Mini Game]`; Game Develop / source); cited on [[overviews/graphics-api]] and [[overviews/game-engine]]; cross-linked [[cpp-3d-game-tutorial-series]], [[intro-to-dx11-revisited]], [[hw3d]], and [[learn-directx]].

- **2026-08-23** — ingest `description:MMRLApp/WebUI-X-Portable`: entity [[webui-x-portable]] (MMRLApp; Kotlin/Jetpack Compose standalone Android app; HybridWebUI engine + JS bridge for root shell/filesystem/module metadata; Magisk/KernelSU/APatch/SukiSU; non-root portable mode + optional spoofed package names; lightweight MMRL WebUI X runtime for module browse/install/configure; cheat / Android root module WebUI); cited on [[overviews/mobile-security]] and [[overviews/game-hacking]]; cross-linked [[magisk]], [[kernelsu]], [[apatch]], [[frida-rs]], [[rescuex]], and [[file-explorer]].
...
- **2026-08-23** — ingest `description:MahmoudZohdy/Process-Injection-Techniques`: entity [[process-injection-techniques]] (MahmoudZohdy; C/C++ Windows injection + persistence collection; CreateRemoteThread/APC/Early Bird/TLS callback/thread hijack/reflective DLL/process hollowing/doppelganging/ghosting + IFEO/AppInit_DLLs/AppCertDlls; unified CLI; security training + offensive research + defensive detection testing in controlled labs; Injection Testing); cited on [[overviews/game-hacking]] and [[overviews/anti-cheat]]; cross-linked [[windows-process-injection]], [[injectors]], [[thread-hijacking-injector]], [[frankenstein-apc-injection]], [[dirty-vanity]], [[poolparty]], [[pi-defender]], [[ghost]], and [[dll-thread-injection-detector]].

- **2026-08-23** — ingest `description:Makk5/FortConsole`: entity [[fortconsole]] (Makk5; C++ x64 Windows DLL; pattern scan + engine object construction to re-enable Unreal in-game console in a specific Fortnite build; low-level UObject enums + memory helpers; internal injection; UE internals exploration + game security research in controlled AC-disabled environments; cheat / game:fortnite); cited on [[overviews/game-engine]] and [[overviews/game-hacking]]; cross-linked [[unreal-object-model]], [[fortkit]], [[basic-fortnite-cheat-source-internal]], [[re-ue4ss]], and [[easy-anti-cheat]].

- **2026-08-23** — ingest `description:ManInMyVan/Minecraft-Anticheat-List`: entity [[minecraft-anticheat-list]] (ManInMyVan; Kotlin/JS + Gradle curated catalog + interactive site; hundreds of validated JSON entries; searchable platform/version/pricing/maintenance table; GitHub + Spigot API enrichment; Bukkit/Sponge/Fabric/Forge/Nukkit/PocketMine; Java + Bedrock; server operators + AC researchers; README Curated catalog of public Minecraft Java/Bedrock anticheats across platforms and versions); cited on [[overviews/anti-cheat]] and [[overviews/game-hacking]]; cross-linked [[minecraft-anti-cheat]], [[nocheatplus]], [[windfall-anticheat]], [[dakotaac]], [[paradox-anticheat]], [[scythe-anticheat]], and [[oomph]].

- **2026-08-23** — ingest `description:ManulMap/malstring`: entity [[malstring]] (ManulMap; C++23 header-only compile-time string and byte-array obfuscation; template metaprogramming XOR stack/call strings and callable arrays; per-string keys; decrypt-on-use; PIC obfuscated literals; static analysis resistance; AC String Crypter / Compile Time; README Using c++23 compile-time magic to produce obfuscated PIC strings and arrays); cited on [[overviews/reverse-engineering]] and [[overviews/anti-cheat]]; cross-linked [[obfuscate]], [[crystr]], [[skcrypter]], [[static-string-obfuscation]], and [[obfusheader-h]].

- **2026-08-23** — ingest `description:MapleStoryUnity/MapleStoryUnity`: entity [[maplestory-unity]] (MapleStoryUnity; Unity MapleStory client reimplementation; C#; WzLib/UnityWzLib encrypted WZ parse; MapleCryptoLib AES + custom packet crypto; JCSUnity 2D character/UI/networking with packet encoders/decoders/login handlers; map/sound/stats/core gameplay; MapleStory-compatible servers; GPL-3.0; Game Engine / source); cited on [[overviews/game-engine]] and [[overviews/reverse-engineering]]; cross-linked [[maple-unity]], [[unistory]], [[wzcomparerr2]], [[maplenecrocer]], and [[maple-research]].
...
- **2026-08-23** — ingest `description:MasterLaplace/LplPlugin`: entity [[lplplugin]] (MasterLaplace; FullDive Engine; modular experimental C++23 Linux engine; xmake static libs; data-oriented ECS, DAG task scheduling, deterministic fixed-point math, Morton spatial partitioning, Vulkan rendering, optional CUDA; lockless zero-copy Linux kernel-module IPC ring buffers + UDP/anti-tunneling; OpenBCI BCI stack with real-time DSP; neuro-immersive game/simulation + BCI gameplay research; README Experimental C++23 engine with Vulkan, ECS, Linux kernel IPC module, and Morton spatial partitioning); cited on [[overviews/game-engine]] and [[overviews/graphics-api]]; cross-linked [[ravengine]], [[vk-engine]], [[lumos]], and [[zig-gamedev]].

- **2026-08-23** — ingest `description:MatheuZSecurity/RingReaper`: entity [[ring-reaper]] (MatheuZSecurity; Linux post-exploitation agent; C agent + Python control server; io_uring async kernel I/O replaces traditional read/write/send/receive syscalls; file transfer, process/user enum, network inspection, session control; offensive security + EDR evasion testing in authorized environments; README Linux post-exploitation agent that uses io_uring to stealthily bypass EDR detection by avoiding traditional syscalls); cited on [[overviews/anti-cheat]] and [[overviews/reverse-engineering]]; cross-linked [[rootkit]], [[ksentinel]], [[tracee]], and [[forensia]].

- **2026-08-23** — ingest `description:MatheuZSecurity/Rootkit`: entity [[rootkit]] (MatheuZSecurity; Linux rootkit sample collection spanning kernel/user/eBPF; file/connection hiding, syscall/ftrace hooking, privesc, persistence, anti-forensics; focused subprojects with build scripts + write-ups; educational offensive/defensive + anti-rootkit detection testing; README Collection of codes focused on Linux rootkits); cited on [[overviews/reverse-engineering]] and [[overviews/anti-cheat]]; cross-linked [[ksentinel]], [[modreveal]], [[rootkit-detection-ebpf-time-trace]], [[venom]], [[kernel-hook-framework]], and [[tracee]].
...
- **2026-08-23** — ingest `description:Mes2d/Screenshot-Detection-Bypass`: entity [[screenshot-detection-bypass]] (Mes2d; C++ PoC; hooks gdi32 `BitBlt` to return clean captures instead of overlay-modified game frames; class-based hook + settings; educational screenshot-detection evasion / capture-hook study; README `[BitBlt]`); cited on [[concepts/anti-screenshot-capture]] and [[overviews/graphics-api]]; cross-linked [[screenshot]], [[getpixel-vs-bitblt-getdibits]], [[not-an-overlay]], [[present-hook]], and [[eac-overlay]].
...
- **2026-08-23** — ingest `description:M3351AN/saphire`: entity [[saphire]] (M3351AN; C++ internal CS:GO cheat framework; DirectX 9 ImGui overlay menu; FreeType fonts + custom ImGui widgets; built-in code editor; modular cheat interface with configuration support; cheat UI framework / Source engine overlay study; README [Internal]); cited on [[overviews/game-hacking]] and [[overviews/graphics-api]]; cross-linked [[csgo-cheat-base]], [[csgo-main-internal]], [[kakhack]], and [[imgui-advanced-cheat-menu]].
...
- **2026-08-22** — ingest `description:NMan1/Internal-Rainbow-Six-Cheat-V3`: entity [[internal-rainbow-six-cheat-v3]] (NMan1; internal R6 Windows cheat framework; kernel injector + manually mapped user-mode DLL; D3D11 rendering/menu; ESP/aimbot/recoil/spread/movement/FOV; kernel-assisted injection + AC detection-surface RE; cheat / game:r6 [Internal]); cited on [[overviews/game-hacking]] and [[overviews/windows-kernel]]; cross-linked [[rainbow-six-cheat]], [[overflow-r6-v2]], [[r6s-internal-cheat]], [[warzone-internal]], [[battleye]], and [[world-to-screen]].

- **2026-08-22** — ingest `description:NMan1/OverflowR6V2`: entity [[overflow-r6-v2]] (NMan1; second-generation R6 external Windows cheat framework; kernel driver inline function hook bypass + user-mode menu/rendering; aimbot/chams/rapid fire/recoil/spread/speed/FOV; kernel-assisted cheat architecture + AC detection tradeoff RE; cheat / game:r6 [External]); cited on [[overviews/game-hacking]] and [[overviews/windows-kernel]]; cross-linked [[rainbow-six-cheat]], [[external-r6s-cheat]], [[r6s-external-v2]], [[overflow-rust]], [[apex-legends-cheat]], [[external-warzone-cheat]], [[battleye]], and [[world-to-screen]].

- **2026-08-22** — ingest `description:NMan1/OverflowRust`: entity [[overflow-rust]] (NMan1; external Windows cheat framework; kernel driver + user-mode rendering/control client; kernel call-chain hook bypass + shared-memory comm; ESP/recoil/automation + gameplay state mods; kernel hook + overlay technique RE; cheat / game:rust [External]); cited on [[overviews/game-hacking]] and [[overviews/windows-kernel]]; cross-linked [[rust-external-cheat]], [[rust-external-1]], [[rainbow-six-cheat]], [[apex-legends-cheat]], [[external-warzone-cheat]], [[easy-anti-cheat]], and [[world-to-screen]].

- **2026-08-22** — ingest `description:NMan1/Rainbow-Six-Cheat`: entity [[rainbow-six-cheat]] (NMan1; full-source R6 Windows cheat framework; kernel driver + external menu + shared-memory comm; loader + rendering + gameplay modules; ESP/chams + silent-aim/recoil/spread + unlock/movement mods; kernel-assisted cheat design RE; cheat / game:r6 [External]); cited on [[overviews/game-hacking]] and [[overviews/windows-kernel]]; cross-linked [[external-r6s-cheat]], [[r6s-external-v2]], [[apex-legends-cheat]], [[external-warzone-cheat]], [[battleye]], and [[world-to-screen]].

- **2026-08-22** — ingest `description:NMan1/apex-legends-cheat`: entity [[apex-legends-cheat]] (NMan1; external C++ Apex Legends cheat architecture; kernel driver + loader + client DLL; separate VS projects for driver logic, usermode loading, and feature modules; ESP/chams + input-assisted aim; syscall-hooking + kernel-thread execution bypass; kernel-mediated cheat pipeline RE; cheat / game:apex legends [External]); cited on [[overviews/game-hacking]] and [[overviews/windows-kernel]]; cross-linked [[apex-legends-driver-cheat]], [[apex-external]], [[external-warzone-cheat]], [[easy-anti-cheat]], and [[world-to-screen]].

- **2026-08-22** — ingest `description:NMan1/external-warzone-cheat`: entity [[external-warzone-cheat]] (NMan1; external C++ COD Warzone cheat framework; manually mapped kernel driver + usermode client; overlay hijack ESP; separate client/driver VS projects + game SDK/offset scaffolding; driver-assisted external tooling RE; cheat / game:cod warzone [External]); cited on [[overviews/game-hacking]] and [[overviews/windows-kernel]]; cross-linked [[warzone-internal]], [[call-of-duty-warzone-mw-hack-esp-aimbot]], [[mwclap]], and [[world-to-screen]].
...
- **2026-08-22** — ingest `description:no1qq/UAGC`: entity [[uagc]] (no1qq; UltimateAntiGamingChair; PaperMC 1.21 Java plugin; modular check engine; confidence/evidence model; staff tooling—exemptions, bypass visibility, alerts, punishments, freeze, integration API; Anti Cheat / game:minecraft); cited on [[overviews/anti-cheat]] and [[overviews/game-hacking]]; cross-linked [[minecraft-anti-cheat]], [[dakotaac]], [[guardac]], [[react]], and [[mlanticheat]].
...
- **2026-08-22** — ingest `description:NurdAlert/flirtnite`: entity [[flirtnite]] (NurdAlert; C++ external Fortnite cheat framework; Hyper-V-based memory interface layer + Unreal structure handling; entity processing + aim modules; DirectX 9 ImGui menu/ESP overlay; offensive tooling / AC evasion research; cheat / game:fortnite [External]); cited on [[overviews/game-hacking]] and [[overviews/graphics-api]]; cross-linked [[modded-voyager]], [[fortnite-external-cheat-leak]], [[interic-fortnite-external-cheat]], [[unreal-object-model]], and [[world-to-screen]].
...
- **2026-08-21** — ingest `description:Saxmason/Interic-Fortnite-External-Cheat`: entity [[interic-fortnite-external-cheat]] (Saxmason; C++ Visual Studio Fortnite external; driver-assisted RPM; Unreal-style math + offset-driven player/weapon discovery; DirectX 9 ImGui overlay/menu; configurable aimbot keybinds + hitbox targeting; visibility-aware ESP + FOV visuals; KeyAuth licensing + anti-debug/anti-dump/string obfuscation; external overlay + evasion research; cheat / game:fortnite [External]); cited on [[overviews/game-hacking]] and [[overviews/anti-cheat]]; cross-linked [[subzero-fortnite-cheat]], [[fortnite-external-cheat-leak]], [[fortnite-external-cheat-base]], [[world-to-screen]], and [[easy-anti-cheat]].

- **2026-08-21** — ingest `description:Saxmason/Subzero-Fortnite-Cheat`: entity [[subzero-fortnite-cheat]] (Saxmason; C++ Visual Studio Fortnite external; kernel-style driver RPM; mesh visibility checks + offset-driven aimbot; DirectX 9 ImGui overlay/menu; NtUserSendInput mouse injection with library spoofing, call-stack spoofing, XOR string obfuscation, optional auth helpers; external overlay + evasion research; cheat / game:fortnite [External]); cited on [[overviews/game-hacking]] and [[overviews/anti-cheat]]; cross-linked [[fortnite-external-cheat-leak]], [[fortnite-external-cheat-base]], [[stack-spoofing]], [[hardware-input-injection]], [[world-to-screen]], and [[easy-anti-cheat]].

- **2026-08-21** — ingest `description:Schich/Lucky-Spark`: entity [[lucky-spark]] (Schich; Windows stealthy shellcode loader; fiber-based execution, JIT decryption, custom cipher, WinHTTP HTTP/HTTPS staging, PEB-walk manual API resolution; Sliver-like tradecraft; cheat / shellcode loader); cited on [[overviews/game-hacking]] and [[overviews/anti-cheat]]; cross-linked [[jektor]], [[nocturneldr]], [[rs-ldr]], [[super-mega]], and [[windows-process-injection]].
...
- **2026-08-21** — ingest `description:Scrut1ny/Hypervisor-Phantom`: entity [[hypervisor-phantom]] (Scrut1ny; Bash automation toolkit for Linux virtualization labs with anti-detection patches; QEMU/EDK2/kernel/VFIO setup modules + host/guest identifier scripts; reproducible VM labs for anti-cheat behavior testing and virtualization security experiments; README Hidden QEMU); cited on [[overviews/anti-cheat]] and [[overviews/game-hacking]]; cross-linked [[qemu-anti-detection]], [[qemu-patched]], [[hardened-qemu]], [[proxmox-ve-anti-detection]], [[kvm-performance]], and [[windows-spoofer]].
...
- **2026-08-20** — ingest `description:Source2ZE/CS2Fixes`: entity [[cs2fixes]] (Source2ZE; C++ Metamod:Source CS2 server plugin; gameplay fixes + zombie-escape server features; hook-driven logic, config/admin tooling, bundled particle/sound assets; practical Source 2 mod integration boilerplate; community CS2 server ops; CS2 mod / game:cs2); cited on [[overviews/game-engine]] and [[overviews/game-hacking]]; cross-linked [[cs2ac]], [[cs2-calladmin]], [[source2gen]], [[cs2-internals]], and [[cs2-sdk]].
...
- **2026-08-20** — ingest `readme:categories`: Anti Cheat ~687 (+2; Cheat ~2732 / Game Develop ~185 / DirectX ~39 / Some Tricks ~117 / Game Engine ~156 stable); refreshed [[overviews/overview]], [[overviews/anti-cheat]], [[overviews/dma-attack]], [[overviews/reverse-engineering]]; light `index.md` section notes (no per-category pages).
...
- **2026-08-20** — ingest `description:gravemaulr/MLAntiCheat`: entity [[mlanticheat]] (gravemaulr; Paper **1.21.4+** Minecraft combat AC plugin; Java 21; ensemble neural + logistic models + anomaly detection over combat rotation features; operator-labeled per-server training sets; Shadow Mode alert review before punishments; optional PacketEvents packet-level rotation tracking; staff alerts, admin GUI, automatic retraining, floating score tags, combat dummy; Anti Cheat / game:minecraft); cited on [[overviews/anti-cheat]], [[overviews/game-hacking]], and [[ai-aimbot-detection]]; cross-linked [[minecraft-anticheatai]], [[minecraft-anti-cheat]], [[dakotaac]], and [[antiguard]].
...
- **2026-08-20** — ingest `readme:categories`: Cheat ~2732 (+1; Anti Cheat ~684 / Game Develop ~185 / DirectX ~39 / Some Tricks ~117 / Game Engine ~156 stable); fixed anti-cheat README-map Cheat cross-link (~2730→~2732); refreshed [[overviews/overview]], [[overviews/game-hacking]], [[overviews/dma-attack]], [[overviews/reverse-engineering]], [[overviews/anti-cheat]]; light `index.md` section notes (no per-category pages).
...
- **2026-08-20** — ingest `description:TheCruZ/Simple-Manual-Map-Injector`: entity [[simple-manual-map-injector]] (compact Windows manual-map DLL injector; C++; x86/x64; optional PE header/section strip; configurable protections; x64 exception handling; sample loader + test DLLs; process injection / manual mapping study; Manual Map; TheCruZ); cited on [[overviews/game-hacking]] and [[windows-process-injection]]; cross-linked [[kdmapper]], [[memject]], [[manual-mapping-dll-injector]], [[modexmap]], and [[guided-hacking-injector]].
...
- **2026-08-19** — ingest `description:WSA-Community/WSA-Linux-Kernel`: entity [[wsa-linux-kernel]] (WSA Linux kernel mirror + build automation; stock + KernelSU branch variants; GitHub Actions x86_64/arm64 images; helper script for KernelSU config patching; reproducible WSA kernel customization; Android/platform security research); cited on [[overviews/mobile-security]] and [[overviews/game-hacking]]; cross-linked [[kernelsu]], [[magiskonwsalocal]], [[wsapatch]], and [[wsa-pacman]].

- **2026-08-19** — ingest `description:Waihbe/Fortnite-Cheat-LEAK`: entity [[fortnite-cheat-leak]] (leaked Fortnite internal cheat source; C++; hook-driven gameplay manipulation + rendering/utility modules; MinHook + Detours function interception; no-spread / movement / vehicle / teleport features; cheat architecture + detection-surface RE; Waihbe; cheat / game:fortnite [Internal]); cited on [[overviews/game-hacking]] and [[overviews/anti-cheat]]; cross-linked [[fortnite-external-cheat-leak]], [[fortnite-hack-esp-exploits-with-menu]], [[basic-fortnite-cheat-source-internal]], [[fortnite-masterpasta-ihack-source-leak]], [[ue4-base]], and [[easy-anti-cheat]].
...
- **2026-08-19** — ingest `description:WsttXm/RiskEngine`: entity [[risk-engine]] (Android risk-control SDK + management platform; device fingerprinting; JNI native checks + system-property analysis for root, emulator, Frida/Xposed hooks, debugger, VPN, sandbox; fraud prevention / game anti-cheat; WsttXm); cited on [[overviews/mobile-security]] and [[concepts/mobile-anti-cheat]]; cross-linked [[device-trust]], [[droidshield]], [[trustdevice-android]], [[frida-detection]], and [[android-emulator-detection]].
...
- **2026-08-19** — ingest `description:XuanXuan-ZhengGui/Minecraft-Anti-Cheat`: entity [[minecraft-anti-cheat]] (UltraAntiCheat; Spigot/Paper **1.13+**; Java 17+ Maven; 13 movement/combat/block/packet modules—fly, speed, timer, KillAura, reach, auto-clicker, scaffold, phase, velocity, no-slow, bad packets, ground spoof, xray; GCD rotation analysis; physics simulation + confidence scoring; optional ProtocolLib; bridges GrimAC/NoCheatPlus/Vulcan/Matrix/Spartan; browser web dashboard; XuanXuan-ZhengGui; Anti Cheat / game:minecraft); cited on [[overviews/anti-cheat]] and [[overviews/game-hacking]]; cross-linked [[dakotaac]], [[windfall-anticheat]], [[ycbr-anticheat]], [[cklsit-advanced-anticheat]], and [[minecraft-anticheatai]].
...
- **2026-08-19** — ingest `description:Y33Tcoder/EzApexDMAAimbot`: entity [[ez-apex-dma-aimbot]] (Apex Legends KVM/DMA aimbot + glow; C/C++; KVM-based memory reader; Linux host reads game state with guest-side control; recoil randomization, non-linear smoothing, target-bone randomization, team-aware glow rendering; experimental DMA workflow + detection-surface reduction research; Y33Tcoder; cheat / game:apex legends [KVM]); cited on [[overviews/dma-attack]] and [[overviews/game-hacking]]; cross-linked [[apex-dma-cheat-updated]], [[cs2-kvm-dma]], [[kvm-csgo-cheat]], [[memflow-kvm]], [[apex-linux]], and [[easy-anti-cheat]].

- **2026-08-19** — ingest `description:YMY1666527646/Call-of-Duty-Warzone-MW-HACK-ESP-AIMBOT`: entity [[call-of-duty-warzone-mw-hack-esp-aimbot]] (COD Warzone/MW external cheat source; C++; Direct3D9 + ImGui overlay/menu templates; driver-backed memory reads + player/entity handling; ESP/aimbot visualization + targeting assistance; overlay and memory-interaction RE practice; YMY1666527646; cheat / game:cod warzone [External]); cited on [[overviews/game-hacking]] and [[overviews/graphics-api]]; cross-linked [[call-of-duty-warzone-hack-esp-slient-aimbot-internal-unlock-all]], [[warzone-internal-cheat]], [[modern-warfare-warzone-cheat]], [[mwclap]], [[world-to-screen]], and [[driver-read-write]].

- **2026-08-19** — ingest `description:YMY1666527646/Fortnite-Hack-Esp-Exploits-With-Menu`: entity [[fortnite-hack-esp-exploits-with-menu]] (Fortnite internal cheat; C++; DirectX 9 ImGui menu; box/line ESP + silent aim + FOV/teleport exploits + panic key; injection/hooking/overlay RE practice; YMY1666527646; cheat / game:fortnite [Internal]); cited on [[overviews/game-hacking]] and [[overviews/graphics-api]]; cross-linked [[basic-fortnite-cheat-source-internal]], [[fortnite-internal-cheat-fixed-and-updated]], [[ue4-base]], [[nigusfn]], [[world-to-screen]], and [[present-hook]].
...
- **2026-08-19** — ingest `description:Ylarod/Florida`: entity [[florida]] (Frida patch/build automation; anti-detection Android `frida-server`; string/symbol/artifact renaming; scripted reproducible builds; mobile RE / anti-instrumentation research; Ylarod); cited on [[overviews/mobile-security]] and [[frida]]; cross-linked [[florida-zygisk]], [[fridare]], [[antifrida]], and [[frida-detection]].
- **2026-08-19** — ingest `description:Ylarod/hardware-breakpoint`: entity [[hardware-breakpoint]] (ARM64 Linux kernel HWBP module; exported APIs + proc interfaces; execution/watch breakpoints by symbol or address; trigger statistics; symbol resolve + phys I/O→virt map; kernel debugging / security research on Android/embedded; Ylarod; HWBP on linux/android); cited on [[overviews/mobile-security]] and [[overviews/reverse-engineering]]; cross-linked [[pwatch]], [[pwatch-c]], [[rw-proc-mem33]], [[rwmem]], [[ida-android-breakpoint]], and [[florida-zygisk]].
- **2026-08-19** — ingest `description:YouNeverKnow00/Anti-Debugger-Protector-Loader`: entity [[anti-debugger-protector-loader]] (Windows C++ anti-debugging/protection example; continuous debugger-process/window-title/driver scans; multiple detection checks + optional auto-termination; configurable scan intervals; VMProtect SDK integration artifacts; software protection / anti-debug pattern study; YouNeverKnow00); cited on [[overviews/anti-cheat]] and [[overviews/reverse-engineering]]; cross-linked [[makin]], [[anti-debugging]], [[gh-anti-debug-bypass-practice-tool]], [[vmprotect]], and [[kernelmode-dll-injector]].
...
- **2026-08-19** — ingest `description:Zpes/mouse-input-injection`: entity [[mouse-input-injection]] (C++ PoC; undocumented **NtUserInjectMouseInput** syscall with custom input structures + movement/click interface; alternative to `SendInput`; automation / input emulation / cheat-adjacent research; Zpes); cited on [[overviews/game-hacking]] and [[overviews/windows-kernel]]; cross-linked [[ntuserinjectmouseinput-syscall]], [[kernel-mouse]], [[hardware-input-injection]], and [[mouseclassservicecallbacktrick]].
...
- **2026-08-19** — ingest `description:zer0condition/GoodmansKernel`: entity [[goodmans-kernel]] (signed WDM driver embedding wasm3; hot-load unsigned wasm32 kernel modules via IOCTL with NT/HAL FFI, InfinityHook trampolines, process/image notify callbacks; HVCI-compliant kernel research / hooking / introspection; zer0condition); cited on [[overviews/windows-kernel]] and [[concepts/hvci]]; cross-linked [[infinityhook]], [[gexec]], and [[kernel-callbacks]].
...
- **2026-08-18** — ingest `description:aquasecurity/tracee`: entity [[tracee]] (Linux runtime security + forensics via eBPF; Go; kernel telemetry + behavioral detections; K8s/container deployment); cited on [[overviews/mobile-security]] and [[overviews/anti-cheat]]; cross-linked [[btrace]], [[peetch]], [[android-ebpf]], and [[wazuh]].
...
- **2026-08-18** — ingest `description:backengineering/POC-ExFlushTb`: entity [[poc-exflushtb]] (C++ Tb-monitoring PoC; Some Tricks / Windows Ring0); cited on [[overviews/windows-kernel]]; cross-linked [[voyager]], [[vdm]], and [[msrexec]].
...
- **2026-08-17** — ingest `description:blacktop/ida-mcp-rs`: entity [[ida-mcp-rs]]; cited on [[overviews/reverse-engineering]] and [[overviews/game-hacking]]; cross-linked [[headless-ida-mcp-server]], [[ida-cli]], [[ida-pro-mcp]], and [[mcp-server-idapro]].
...
- **2026-08-17** — ingest `description:levifrsn63/krunker-loader`: entity [[krunker-loader]]; cited on [[overviews/game-hacking]] and [[overviews/anti-cheat]]; cross-linked [[webcheat]], [[js-debugger-bypass-script]], [[javascript-obfuscator]], and [[ff3mmo]].
...
- **2026-08-17** — ingest `description:ch3rn0byl/WinDbg-Extensions`: entity [[windbg-extensions]]; cited on [[concepts/kernel-callbacks]] and [[overviews/windows-kernel]]; cross-linked [[kernel-callback-functions-list]], [[openark]], [[winobjex64]], [[windbg-scripts]], and [[windbg-decompile-ext]].
...
- **2026-08-16** — ingest `description:crosire/reshade`: entity [[reshade]]; cited on [[overviews/graphics-api]] and [[present-hook]]; cross-linked [[shader-injector]] and [[swapchain-bottleneck]].
...
- **2026-08-16** — ingest `description:crytic/ida-evm`: entity [[ida-evm]]; cited on [[overviews/reverse-engineering]] and [[overviews/game-hacking]]; cross-linked [[ethersplay]], [[ida-sdk]], and [[yaravm]].

- **2026-08-16** — ingest `description:cs1ime/AndroidSuperInject`: entity [[android-super-inject]]; cited on [[overviews/mobile-security]] and [[overviews/game-hacking]]; cross-linked [[android-ptrace-injector]], [[android-mod-games-by-inject-zygote]], and [[linjector-rs]].
...
- **2026-08-16** — ingest `description:cyberark/DLLSpy`: entity [[dllspy]]; cited on [[overviews/game-hacking]] and [[overviews/anti-cheat]]; cross-linked [[windows-dll-hijacking]], [[hijacklibs]], [[dllirant]], and [[impulsive-dll-hijack]].
...
- **2026-08-16** — ingest `description:dabao1955/kernel_build_action`: entity [[kernel-build-action]]; cited on [[overviews/mobile-security]] and [[overviews/game-hacking]]; cross-linked [[compile-android-driver]] and [[android-kernel-hacking-toolkit]].

- **2026-08-16** — ingest `description:danbrodsky/GFred`: entity [[gfred]]; cited on [[overviews/reverse-engineering]] and [[overviews/game-hacking]]; cross-linked [[ghidra]], [[ghidrassist]], and [[gpthidra]].

- **2026-08-16** — ingest `description:danhuynh0803/Campfire`: entity [[campfire]]; cited on [[overviews/game-engine]] and [[overviews/graphics-api]]; cross-linked [[exengine]], [[liblava]], and [[raylib]].
...
- **2026-08-16** — ingest `description:danielkrupinski/VAC`: entity [[vac]]; cited on [[overviews/anti-cheat]] and [[overviews/reverse-engineering]]; cross-linked [[como-funciona-vac]], [[cs2-anticheat]], and [[vac-hooks]].
...
- **2026-08-16** — ingest `description:danielplohmann/gui-plugin-template`: entity [[gui-plugin-template]]; cited on [[overviews/reverse-engineering]]; cross-linked [[binsync]], [[hyara]], [[mcrit-plugin]], and [[classy]].
...
- **2026-08-16** — ingest `description:david942j/kvm-kernel-example`: entity [[kvm-kernel-example]]; cited on [[overviews/windows-kernel]] and [[overviews/reverse-engineering]]; cross-linked [[memflow-kvm]], [[ntoseye]], and [[kernel-development]].

- **2026-08-16** — ingest `description:dayzerosec/AMD-SP-Loader`: entity [[amd-sp-loader]]; cited on [[overviews/reverse-engineering]] and [[overviews/windows-kernel]]; cross-linked [[efixplorer]], [[fiano]], and [[binary-ninja-mcp]].
...
- **2026-08-16** — ingest `description:duddel/yourgamelib`: entity [[yourgamelib]]; cited on [[overviews/game-engine]] and [[overviews/graphics-api]]; cross-linked [[raylib]], [[exengine]], and [[gameplay]].
...
- **2026-08-16** — ingest `description:dword64/Ow-Anti-Flag`: entity [[ow-anti-flag]]; cited on [[overviews/game-hacking]] and [[overviews/anti-cheat]]; cross-linked [[ow-fov]] and [[hwid-steam-spyware-terminator]].
...
- **2026-08-16** — ingest `description:ekknod/MouseClassServiceCallbackMeme`: entity [[mouseclassservicecallbackmeme]]; cited on [[overviews/windows-kernel]] and [[overviews/game-hacking]]; cross-linked [[mouseclassservicecallbacktrick]], [[kernel-mouse]], and [[ntuserinjectmouseinput-syscall]].

- **2026-08-16** — ingest `description:ekknod/MouseClassServiceCallbackTrick`: entity [[mouseclassservicecallbacktrick]]; cited on [[overviews/windows-kernel]] and [[overviews/game-hacking]]; cross-linked [[kernel-mouse]], [[logitech-cve]], and [[ntuserinjectmouseinput-syscall]].

- **2026-08-16** — ingest `description:ekknod/Nmi`: entity [[nmi]]; cited on [[overviews/windows-kernel]] and [[overviews/anti-cheat]]; cross-linked [[nmi-callback-blocker2]], [[disable-nmi-callbacks]], and [[nmi-nmi-callback]].
...
- **2026-08-15** — ingest `description:es3n1n/obfuscator`: entity [[obfuscator]]; cited on [[overviews/reverse-engineering]] and [[control-flow-flattening]]; cross-linked [[alcatraz]], [[binprotect]], and [[perses]].
...
- **2026-08-15** — ingest `description:ex0dus-0x/ward`: entity [[ward]]; cited on [[overviews/anti-cheat]] and [[overviews/reverse-engineering]]; cross-linked [[elfpacker]], [[woody-woodpacker]], and [[m0dern-p4cker]].
...
- **2026-08-15** — ingest `description:enis1enis2/Windfall-AntiCheat`: entity [[windfall-anticheat]]; cited on [[overviews/anti-cheat]] and [[overviews/game-hacking]]; cross-linked [[windfall-anticheatf]], [[dakotaac]], and [[avaanticheat]].

- **2026-08-15** — ingest `description:eksses/EAFE`: entity [[eafe]]; cited on [[overviews/anti-cheat]] and [[overviews/game-hacking]]; cross-linked [[phantom-client]], [[lenrete-mod]], and [[windfall-anticheat]].

- **2026-08-15** — ingest `description:enis1enis2/WindfallAntiCheatF`: entity [[windfall-anticheatf]]; cited on [[overviews/anti-cheat]] and [[overviews/game-hacking]]; cross-linked [[dakotaac]], [[avaanticheat]], and [[lenrete-mod]].
...
- **2026-08-15** — ingest `description:friedkiwi/netcrypt`: entity [[netcrypt]]; cited on [[overviews/anti-cheat]] and [[overviews/reverse-engineering]]; cross-linked [[confuserex]], [[xorpacker]], and [[obfuscar]].
...
- **2026-08-15** — ingest `description:gmh5225/AI-FPS-b00m-h3adsh0t`: entity [[ai-fps-b00m-h3adsh0t]]; cited on [[overviews/game-hacking]] and [[ai-aimbot-detection]]; cross-linked [[yolov5-pubg]], [[opencv-smart-aimbot]], and [[pine]].
...
- **2026-08-15** — ingest `description:gmh5225/AntiDebugandMemoryDump`: entity [[antidebugandmemorydump]]; cited on [[overviews/mobile-security]] and [[overviews/anti-cheat]]; cross-linked [[anticheat-android-cheap-engine]], [[memdumper]], and [[mobile-anti-cheat]].
...
- **2026-08-14** — ingest `description:gmh5225/BF1-ESP-AND-AIMBOT`: entity [[bf1-esp-and-aimbot]]; cited on [[overviews/game-hacking]] and [[overviews/graphics-api]]; cross-linked [[battlefield-1-internal]], [[bf4-internal-overlay]], [[present-hook]], and [[world-to-screen]].
...
- **2026-08-14** — ingest `description:gmh5225/CS2-Cheat-Base`: entity [[cs2-cheat-base]]; cited on [[overviews/game-hacking]] and [[overviews/game-engine]]; cross-linked [[cs2-cheat]], [[cs2-sdk]], and [[cs2-internal]].

- **2026-08-14** — ingest `description:gmh5225/CS2-Cheat`: updated [[cs2-cheat]] (gmh5225 internal section); cited on [[overviews/game-hacking]] and [[overviews/game-engine]]; cross-linked [[asphyxia-cs2]], [[cs2-internal]], and [[cs2-sdk]].
...
- **2026-08-14** — ingest `description:gmh5225/CSHackCreator-2-Demo`: entity [[cshackcreator-2-demo]]; cited on [[overviews/game-hacking]] and [[overviews/graphics-api]]; cross-linked [[hpp-hack]], [[oxware]], and [[cs16-trigger-kvm]].
...
- **2026-08-14** — ingest `description:gmh5225/CallStackSpoofer-2`: entity [[callstackspoofer-2]]; cited on [[stack-spoofing]] and [[overviews/game-hacking]]; cross-linked [[spoof-stack-safecall]] and [[stack-spoofer-macro]].
...
- **2026-08-13** — ingest `description:gmh5225/Dse-Patcher-2`: entity [[dse-patcher-2]]; cited on [[overviews/windows-kernel]] and [[overviews/anti-cheat]].
...
- **2026-08-13** — ingest `description:gmh5225/EldenRingLauncher`: entity [[eldenringlauncher]]; cited on [[overviews/game-hacking]] and [[easy-anti-cheat]]; cross-linked from [[elden-ring-ct-tga]].
...
- **2026-08-13** — ingest `description:gmh5225/EtherealEngine`: entity [[ethereal-engine]]; cited on [[overviews/game-engine]].

- **2026-08-13** — ingest `description:gmh5225/EvilKaspersky`: entity [[evil-kaspersky]]; cited on [[concepts/byovd]] and [[overviews/windows-kernel]]; cross-linked from [[kaspersky-hook]].
...
- **2026-08-13** — ingest `description:gmh5225/Fortnite-External-4`: entity [[fortnite-external-4]]; cited on [[overviews/game-hacking]] and [[overviews/windows-kernel]]; cross-linked [[fortnite-external]], [[fortnite-external-5]], [[dolboeb-executor]], and [[ksocket]].
...
- **2026-08-13** — ingest `description:gmh5225/Fortnite-External`: entity [[fortnite-external]]; cited on [[overviews/game-hacking]] and [[overviews/windows-kernel]]; cross-linked [[fortnite-ud-external]] and [[fortnite-external-base-source]].
...
- **2026-08-13** — ingest `description:gmh5225/Fortnite-Internal-Cheat-Fixed-and-Updated`: entity [[fortnite-internal-cheat-fixed-and-updated]]; cited on [[overviews/game-hacking]] and [[overviews/graphics-api]]; cross-linked [[fortnite-internal-updated-ritz]] and [[zerogui-fortnite-internal]].
...
- **2026-08-12** — ingest `readme:categories`: bumped Cheat ~2694 (was ~2693; Anti Cheat ~665 / Some Tricks ~117 / DirectX ~38 stable); refreshed [[overviews/overview]], [[overviews/anti-cheat]], [[overviews/game-hacking]], [[overviews/dma-attack]], [[overviews/reverse-engineering]]; light `index.md` section notes (no per-category pages).
...
- **2026-08-12** — ingest `description:gmh5225/IDA-KallsymsSymbolRenamer`: entity [[ida-kallsyms-symbol-renamer]]; cited on [[overviews/reverse-engineering]] and [[overviews/game-hacking]]; cross-linked from [[vmlinux-to-elf]] and [[list-of-ida-plugins]].
...
- **2026-08-12** — ingest `description:gmh5225/Killer`: entity [[killer]]; cited on [[byovd]] and [[overviews/windows-kernel]].
...
- **2026-08-12** — ingest `description:gmh5225/LSASS-DumpThatLSASS`: entity [[lsass-dump-that-lsass]]; cited on [[overviews/windows-kernel]] and [[overviews/anti-cheat]].

- **2026-08-12** — ingest `description:ianveig29/OverlayAI`: entity [[overlayai]]; cited on [[overviews/game-hacking]] and [[overviews/graphics-api]]; cross-link from [[cs2-internals]].
...
- **2026-08-11** — ingest `description:gmh5225/NtUserInjectMouseInput-syscall`: entity [[ntuserinjectmouseinput-syscall]]; cited on [[overviews/windows-kernel]] and [[overviews/game-hacking]].
...
- **2026-08-11** — ingest `description:salvogiangri/KnoxPatch`: entity [[knoxpatch]]; cited on [[overviews/mobile-security]] and [[mobile-anti-cheat]].
...
- **2026-08-11** — ingest `description:gmh5225/PUBG_Internal`: updated entity [[pubg-internal]] (gmh5225 D3D11 Present-hook variant); cited on [[present-hook]] and [[overviews/game-hacking]].
...
- **2026-08-11** — ingest `description:gmh5225/Pom-Pom`: entity [[pom-pom]]; cited on [[overviews/game-hacking]]; cross-link from [[star-rail]].

- **2026-08-11** — ingest `description:gmh5225/Ponce`: entity [[ponce]]; cited on [[overviews/reverse-engineering]] and [[overviews/game-hacking]].
...
- **2026-08-10** — ingest `description:gmh5225/Rebirth`: entity [[rebirth]]; cited on [[overviews/game-hacking]] and [[overviews/game-engine]].
...
- **2026-08-10** — ingest `description:gmh5225/RToolZ`: entity [[rtoolz]]; cited on [[overviews/windows-kernel]] and [[kernel-callbacks]].
...
- **2026-08-10** — ingest `description:gmh5225/Rust-Cheat-External`: entity [[rust-cheat-external]]; cited on [[overviews/game-hacking]] and [[overviews/windows-kernel]].
...
- **2026-08-10** — ingest `description:gmh5225/StealthAPCDispatcher`: entity [[stealth-apc-dispatcher]]; cited on [[overviews/windows-kernel]] and [[overviews/game-hacking]].
...
- **2026-08-10** — ingest `description:gmh5225/TWMS-Hacking-Data`: entity [[twms-hacking-data]]; cited on [[overviews/game-hacking]] and [[overviews/anti-cheat]].
...
- **2026-08-10** — ingest `description:gmh5225/VACDumper`: entity [[vac-dumper]]; cited on [[overviews/anti-cheat]] and [[overviews/game-hacking]].

- **2026-08-10** — ingest `description:gmh5225/VALORANT-HACK-ESP-AIMBOT-SKINCHANGER-SOURCE`: entity [[valorant-hack-esp-aimbot-skinchanger-source]]; cited on [[vanguard]] and [[overviews/game-hacking]].
...
- **2026-08-10** — ingest `description:gmh5225/Vac-Emulator`: entity [[vac-emulator]]; cited on [[overviews/anti-cheat]] and [[overviews/game-hacking]].

- **2026-08-10** — ingest `readme:categories`: bumped Anti Cheat ~658 (was ~657; Cheat ~2665 / Some Tricks ~116 / DirectX ~38 stable); refreshed [[overviews/overview]], [[overviews/anti-cheat]], [[overviews/dma-attack]], [[overviews/reverse-engineering]]; light `index.md` section notes (no per-category pages).
...
- **2026-08-10** — ingest `description:gmh5225/Valorant-Aimbot-Bypass`: entity [[valorant-aimbot-bypass]]; cited on [[vanguard]] and [[overviews/game-hacking]].
...
- **2026-08-09** — ingest `description:gmh5225/YaeAchievement`: entity [[yae-achievement]]; cited on [[overviews/game-hacking]] and [[overviews/game-engine]].

- **2026-08-09** — ingest `description:gmh5225/ZeroGui-Fortnite-Internal`: entity [[zerogui-fortnite-internal]]; cited on [[overviews/game-hacking]] and [[easy-anti-cheat]].

- **2026-08-09** — ingest `description:gmh5225/ZeroHVCI`: entity [[zero-hvci]]; cited on [[hvci]] and [[overviews/windows-kernel]].

- **2026-08-09** — ingest `description:gmh5225/alt-V-Anticheat-Guide`: entity [[alt-v-anticheat-guide]]; cited on [[overviews/anti-cheat]] and [[overviews/game-hacking]].
...
- **2026-08-09** — ingest `description:gmh5225/autismware`: entity [[autismware]]; cited on [[overviews/game-hacking]] and [[overviews/graphics-api]].

- **2026-08-09** — ingest `description:gmh5225/avhook`: entity [[avhook]]; cited on [[overviews/game-hacking]] and [[overviews/anti-cheat]].
...
- **2026-08-09** — ingest `description:gmh5225/cs2_things`: entity [[cs2-things]]; cited on [[overviews/game-hacking]] and [[source-netvars]].
...
- **2026-08-09** — ingest `description:gmh5225/csgo-sdk`: updated entity [[csgo-sdk]] (gmh5225/csgo-sdk alongside csgo_sdk variant); cited on [[overviews/game-hacking]] and [[source-netvars]].
...
- **2026-08-08** — ingest `description:gmh5225/ghidra`: entity [[ghidra]]; cited on [[overviews/reverse-engineering]] and [[overviews/game-hacking]].
...
- **2026-08-08** — ingest `description:gmh5225/gtav-sourcecode-build-guide`: entity [[gtav-sourcecode-build-guide]]; cited on [[overviews/game-engine]] and [[overviews/reverse-engineering]].

- **2026-08-08** — ingest `description:gmh5225/hh-lol-prophet`: entity [[hh-lol-prophet]]; cited on [[overviews/game-hacking]] and [[vanguard]].
...
- **2026-08-08** — ingest `description:gmh5225/ida-dark-plus`: entity [[ida-dark-plus]]; cited on [[overviews/reverse-engineering]]; cross-linked from [[long-night]].
...
- **2026-08-08** — ingest `description:gmh5225/ida_export_functions`: entity [[ida-export-functions]]; cited on [[overviews/reverse-engineering]] and [[overviews/game-hacking]].

- **2026-08-08** — ingest `description:gmh5225/ida_medigate`: entity [[ida-medigate]]; cited on [[overviews/reverse-engineering]] and [[overviews/game-hacking]].

- **2026-08-08** — ingest `description:gmh5225/ida_names`: entity [[ida-names]]; cited on [[overviews/reverse-engineering]] and [[overviews/game-hacking]].

- **2026-08-08** — ingest `description:gmh5225/ida_ps5_elf_plugin`: entity [[ida-ps5-elf-plugin]]; cited on [[overviews/reverse-engineering]] and [[overviews/game-hacking]]; cross-linked from [[ida-ps4-helper]].
...
- **2026-08-08** — ingest `description:gmh5225/idasdk-collection`: entity [[idasdk-collection]]; cited on [[overviews/reverse-engineering]] and [[overviews/game-hacking]].
...
- **2026-08-08** — ingest `description:gmh5225/maniac`: entity [[maniac]]; cited on [[overviews/game-hacking]]; cross-linked from [[osu]].
...
- **2026-08-08** — ingest `readme:categories`: bumped Cheat ~2661 (was ~2660; Anti Cheat ~651 / Some Tricks ~114 / Game Develop ~183 / Game Engine ~155 stable); refreshed [[overviews/overview]], [[overviews/game-hacking]], [[overviews/anti-cheat]], [[overviews/dma-attack]], [[overviews/reverse-engineering]]; light `index.md` section notes (no per-category pages).

- **2026-08-08** — ingest `description:gmh5225/nvidia-overlay-hijack`: entity [[nvidia-overlay-hijack]]; cited on [[overviews/graphics-api]] and [[overviews/game-hacking]].
...
- **2026-08-07** — ingest `description:gmh5225/qiling-il2cpp-dump`: entity [[qiling-il2cpp-dump]]; cited on [[il2cpp]] and [[overviews/game-engine]].
...
- **2026-08-07** — ingest `description:gmh5225/r0ak`: entity [[r0ak]]; cited on [[overviews/windows-kernel]] and [[overviews/reverse-engineering]].
...
- **2026-08-07** — ingest `description:gmh5225/teamfortress2_internal`: entity [[teamfortress2-internal]]; cited on [[overviews/game-hacking]] and [[source-engine]].
...
- **2026-08-07** — ingest `description:gmh5225/valo-driver`: entity [[valo-driver]]; cited on [[vanguard]] and [[overviews/game-hacking]].

- **2026-08-07** — ingest `description:gmh5225/valorant-esp-hack-with-driver`: entity [[valorant-esp-hack-with-driver]]; cited on [[vanguard]] and [[overviews/game-hacking]].
...
- **2026-08-07** — ingest `description:gmh5225/wasm-ceserver`: entity [[wasm-ceserver]]; cited on [[overviews/game-hacking]] and [[overviews/reverse-engineering]].

- **2026-08-07** — ingest `description:gmh5225/win32k_file_collection`: entity [[win32k-file-collection]]; cited on [[overviews/windows-kernel]] and [[overviews/reverse-engineering]].
...
- **2026-08-07** — ingest `description:google/binexport`: entity [[binexport]]; cited on [[overviews/reverse-engineering]]; cross-linked [[diaphora]].

- **2026-08-07** — ingest `description:not1cyyy/PowerVM`: entity [[powervm]]; cited on [[overviews/windows-kernel]] and [[overviews/anti-cheat]].

- **2026-08-07** — ingest `readme:categories`: bumped Cheat ~2657 (was ~2656; Anti Cheat ~647 / Some Tricks ~114 / Game Develop ~183 / Game Engine ~155 stable); refreshed [[overviews/overview]], [[overviews/game-hacking]], [[overviews/anti-cheat]], [[overviews/dma-attack]], [[overviews/reverse-engineering]]; light `index.md` section notes (no per-category pages).
...
- **2026-08-06** — ingest `description:guided-hacking/GuidedHacking-Injector`: entity [[guided-hacking-injector]]; cited on [[overviews/game-hacking]] and [[overviews/anti-cheat]].
...
- **2026-08-05** — ingest `description:horsicq/nfdx64dbg`: entity [[nfdx64dbg]]; cited on [[x64dbg]], [[overviews/reverse-engineering]], and [[overviews/game-hacking]].
...
- **2026-08-05** — ingest `description:horsicq/x64dbg-Plugin-Manager`: entity [[x64dbg-plugin-manager]]; cited on [[x64dbg]], [[overviews/reverse-engineering]], and [[overviews/game-hacking]].
...
- **2026-08-05** — ingest `readme:categories`: bumped Cheat ~2654 (was ~2653; Anti Cheat ~643 / Game Develop ~183 / Game Engine ~155 stable); refreshed README map counts on [[overviews/overview]], [[overviews/game-hacking]], [[overviews/anti-cheat]], [[overviews/dma-attack]], [[overviews/reverse-engineering]]; light `index.md` section notes (no per-category pages).

- **2026-08-05** — ingest `description:hx1997/dayu`: entity [[dayu]]; cited on [[overviews/mobile-security]] and [[overviews/reverse-engineering]].
...
- **2026-08-04** — ingest `description:igromanru/R6-Chams-public`: entity [[r6-chams-public]]; cited on [[overviews/game-hacking]] and [[overviews/graphics-api]].
...
- **2026-08-04** — ingest `readme:categories`: bumped Anti Cheat ~642 (was ~641; Cheat ~2651 / Game Develop ~183 / Game Engine ~155 stable); refreshed README map counts on [[overviews/overview]], [[overviews/anti-cheat]], [[overviews/dma-attack]], [[overviews/reverse-engineering]]; light `index.md` section notes (no per-category pages).

- **2026-08-04** — ingest `description:inflation/goldberg_emulator`: entity [[goldberg-emulator]]; cited on [[overviews/game-hacking]] and [[overviews/reverse-engineering]].
...
- **2026-08-04** — ingest `description:inuNorii/Elden-Ring-CT-TGA`: entity [[elden-ring-ct-tga]]; cited on [[overviews/game-hacking]] and [[concepts/easy-anti-cheat]].
...
- **2026-08-04** — ingest `description:issuimo/UnityResolve.hpp`: entity [[unityresolve-hpp]]; cited on [[overviews/game-engine]] and [[overviews/game-hacking]].
...
- **2026-07-25** — ingest `description:radareorg/r2a`: entity [[r2a]] (retired; → [[r2ai]]); cited on [[overviews/reverse-engineering]] and [[overviews/game-hacking]].
...
- **2026-07-25** — ingest `description:rabbitfishy/sdk`: entity [[sdk]]; cited on [[overviews/game-engine]] and [[overviews/game-hacking]].
...
- **2026-07-26** — ingest `description:openeggbert/free-direct`: entity [[free-direct]]; cited on [[overviews/graphics-api]] and [[overviews/game-hacking]].
...
- **2026-07-27** — ingest `readme:categories`: refreshed README maps on [[overviews/overview]], [[overviews/anti-cheat]], [[overviews/game-hacking]], [[overviews/dma-attack]], [[overviews/reverse-engineering]] (Cheat ~2592; PlayStation ~7 PSFree host; Anti Cheat ~613 / Game Engine ~149 / Game Develop ~182 / DirectX ~34 stable); light `index.md` section notes (no per-category pages).

- **2026-07-27** — ingest `description:obama-gaming/xor-float`: entity [[xor-float]]; cited on [[overviews/anti-cheat]] and [[overviews/reverse-engineering]]; cross-link from [[encrypted-value]].
...
- **2026-07-29** — ingest `skill:anti-cheat`: refreshed [[overviews/anti-cheat]] (detection methodology, hypervisor EPT defense); concepts [[kernel-pool-scanning]], [[ai-aimbot-detection]]; expanded [[dma]] AC detection pipeline; updated `index.md`.
...
- **2026-07-29** — ingest `skill:windows-kernel`: refreshed [[overviews/windows-kernel]] (symbol walking, VBS/HVCI, Segment Heap forensics, ETW TI, hypervisor EPT defense, research-rigor); concepts [[kernel-pool-scanning]], [[hvci]], [[etw-threat-intelligence]]; updated `index.md`.
...
- **2026-07-29** — ingest `description:mojtabafalleh/emulator`: entity [[emulator]]; cited on [[overviews/reverse-engineering]] and [[overviews/windows-kernel]].
...
- **2026-07-29** — ingest `description:momalab/e3`: entity [[e3]]; cited on [[overviews/anti-cheat]] and [[overviews/reverse-engineering]].
...
- **2026-07-30** — ingest `description:yottaawesome/intro-to-dx11-revisited`: entity [[intro-to-dx11-revisited]]; cited on [[overviews/graphics-api]] and [[overviews/game-engine]].
...
- **2026-07-30** — ingest `description:thelok1s/florida-zygisk`: entity [[florida-zygisk]]; cited on [[frida]] and [[overviews/mobile-security]].
...
- **2026-07-31** — ingest `description:mahmoudimus/ida-taskr`: entity [[ida-taskr]]; cited on [[overviews/reverse-engineering]] and [[overviews/game-hacking]].
...
- **2026-07-31** — ingest `description:mahaloz/DAILA`: entity [[daila]]; cited on [[overviews/reverse-engineering]] and [[overviews/game-hacking]].
...
- **2026-07-31** — ingest `description:mytechnotalent/Embedded-Hacking`: entity [[embedded-hacking]]; cited on [[overviews/reverse-engineering]] and [[overviews/game-hacking]]; cross-linked [[hacking-rust]] and [[go-hacking]].
...
- **2026-07-31** — ingest `description:litemars/hARMless`: entity [[harmless]]; cited on [[overviews/anti-cheat]] and [[overviews/reverse-engineering]].
...
- **2026-08-01** — ingest `description:kristofhracza/tim_apple`: entity [[tim-apple]]; cited on [[overviews/game-hacking]] and [[overviews/game-engine]].
...
- **2026-08-01** — ingest `description:klezVirus/BYOUD`: entity [[byoud]]; cited on [[stack-spoofing]] and [[overviews/game-hacking]].
...
- **2026-08-01** — ingest `description:kkpwn/ErisDbg`: entity [[erisdbg]]; cited on [[overviews/windows-kernel]] and [[overviews/reverse-engineering]].

- **2026-08-02** — ingest `description:kkkbbb/rustFrida`: entity [[rust-frida]]; cited on [[frida]] and [[overviews/mobile-security]].

- **2026-08-02** — ingest `description:kkkbbb/mkpms`: entity [[mkpms]]; cited on [[rust-frida]], [[frida]], and [[overviews/mobile-security]].
...
- **2026-08-02** — ingest `description:kirovgrad/Renamaida`: entity [[renamaida]]; cited on [[overviews/reverse-engineering]] and [[overviews/game-hacking]].
...
- **2026-08-02** — ingest `description:jtang613/IDAssist`: entity [[idassist]]; cited on [[overviews/reverse-engineering]] and [[overviews/game-hacking]].
...
- **2026-08-03** — ingest `description:javascript-obfuscator/javascript-obfuscator`: entity [[javascript-obfuscator]]; cited on [[overviews/reverse-engineering]] and [[overviews/anti-cheat]].
...
- **2026-08-03** — ingest `description:sorrelhub/shprotect-ac`: entity [[shprotect-ac]]; cited on [[overviews/anti-cheat]] and [[overviews/game-engine]].
...
- **2026-08-05** — ingest `description:huoji120/goodeye`: entity [[goodeye]]; cited on [[battleye]] and [[overviews/windows-kernel]].

- **2026-08-05** — ingest `description:hugsy/ropgadget-rs`: entity [[ropgadget-rs]]; cited on [[overviews/reverse-engineering]] and [[overviews/windows-kernel]].
...
- **2026-08-06** — ingest `description:halloweeks/pubg-mobile-pak-extract`: entity [[pubg-mobile-pak-extract]]; cited on [[overviews/mobile-security]] and [[overviews/game-hacking]].

- **2026-08-06** — ingest `description:hanickadot/cthash`: entity [[cthash]]; cited on [[overviews/anti-cheat]] and [[overviews/reverse-engineering]].
...
- **2026-08-09** — ingest `description:gmh5225/Wizard-Loader`: entity [[wizard-loader]]; cited on [[overviews/game-hacking]] and [[overviews/anti-cheat]].
...
- **2026-08-10** — ingest `description:gmh5225/UE5-FPS-CryptRaider`: entity [[ue5-fps-crypt-raider]]; cited on [[overviews/game-engine]] and [[overviews/reverse-engineering]].
...
- **2026-08-12** — ingest `description:gmh5225/GenshinDebuggerBypass`: entity [[genshin-debugger-bypass]]; cited on [[overviews/reverse-engineering]] and [[overviews/game-hacking]]; cross-linked [[mhyprot2]].
