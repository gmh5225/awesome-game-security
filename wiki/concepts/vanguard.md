...
Kernel external memory-read drivers such as [[valo-driver]] (C; physical translate / CR3 / MDL paths; avoids monitored standard APIs; gmh5225) demonstrate Vanguard-specific cross-process R/W bypass research beside generic CR3/MDL tooling. (source: wiki/sources/descriptions/gmh5225__valo-driver.md) Kernel-driver ESP/aimbot/skin-changer samples such as [[valorant-hack-esp-aimbot-skinchanger]] (UE4 entity overlays; aim smoothing; client-side skin modification; bypasses user-mode protections; gmh5225) complement that lane for studying multi-feature cheat stacks under Vanguard. (source: wiki/sources/descriptions/gmh5225__VALORANT-HACK-ESP-AIMBOT-SKINCHANGER.md) C++ source samples such as [[valorant-hack-esp-aimbot-skinchanger-source]] (typical Valorant cheat architecture; kernel-driver UE4 reads; Vanguard kernel protection bypass; gmh5225) extend that lane for studying full cheat-stack implementation patterns. (source: wiki/sources/descriptions/gmh5225__VALORANT-HACK-ESP-AIMBOT-SKINCHANGER-SOURCE.md)
...
Historical League of Legends client mod/patcher samples such as [[lol-patcher]] (gmh5225; experimental; frozen Feb 2020) illustrate LoL-side offensive research under the same Vanguard-protected Riot title family as Valorant. (source: wiki/sources/descriptions/gmh5225__lol_patcher.md) LoL client unpacker samples such as [[lol-unpackman]] (C++; gmh5225) complement that lane for client-binary unpacking study. (source: wiki/sources/descriptions/gmh5225__lol-unpackman.md) LoL offset dump tooling such as [[lol-offset-dumper]] (C/C++; memory analysis; gmh5225) complements that lane for live client layout dumps. (source: wiki/sources/descriptions/gmh5225__lol-offset-dumper.md) LoL process memory dump tooling such as [[league-dumper]] (Process Dump fork; LoL code encryption; hidden modules, loose code chunks, import reconstruction; gmh5225) complements that lane for full PE reconstruction under Vanguard protections. (source: wiki/sources/descriptions/gmh5225__LeagueDumper.md) LoL `.text` decrypt/dump tooling such as [[league-unpacker]] (DLL injection; decrypts protected `.text`; dumps for IDA static analysis with manual base input; gmh5225) complements that lane for `.text`-focused static RE under Vanguard protections. (source: wiki/sources/descriptions/gmh5225__League-Unpacker.md) LoL cheat base frameworks such as [[league-base]] (C++; memory read, object enumeration, champion data, overlay rendering; Packman/Vanguard considerations; gmh5225) illustrate full cheat scaffold research in that same LoL lane. (source: wiki/sources/descriptions/gmh5225__league-base.md) LoL modding samples such as [[hh-lol-prophet]] (Go; hh lol prophet; gmh5225) complement that lane for client modding study. (source: wiki/sources/descriptions/gmh5225__hh-lol-prophet.md) LoL assistant client samples such as [[frank]] (JavaScript; WeGame replacement; rendering/animation/asset pipelines; gmh5225) complement that lane for launcher/client-side study. (source: wiki/sources/descriptions/gmh5225__frank.md) Custom or modified LoL client implementations such as [[lol-client]] (gmh5225; alternative client/protocol for client-server communication and game-state analysis) complement that lane for wire and state-management study. (source: wiki/sources/descriptions/gmh5225__LoLClient.md) LoL external script platforms such as [[ayaya-league-external]] (Node.js; AyayaLeague; custom user scripts; gmh5225) complement that lane for out-of-process scripting automation. (source: wiki/sources/descriptions/gmh5225__ayaya-league-external.md) LoL external viewing tools such as [[lviewlol]] (Python; external memory read; minimap/player positions/cooldown overlay; gmh5225) complement that lane for out-of-process game-state visualization. (source: wiki/sources/descriptions/gmh5225__LViewLoL.md) LoL LCU bot extension samples such as [[kbotext]] (programmable bot interface; automated scripting and client control; README `[LCU]`; gmh5225) complement that lane for League Client Update API automation study. (source: wiki/sources/descriptions/gmh5225__KBotExt.md) LoL/TFT client-side skin changer samples such as [[r3nzskin-tft]] (C++; patches champion skin data structures in memory; client-only cosmetic display; README `[Skin]`; gmh5225) complement that lane for studying cosmetic manipulation that avoids server-side skin validation. (source: wiki/sources/descriptions/gmh5225__R3nzSkinTFT.md) Internal LoL skin changer samples such as [[league-skin-changer]] (DirectX 9/11 hooks + ImGui menu; champion/minion/jungle mob skins; auto skin-database updates; README `[Skin]`; gmh5225) complement that lane for studying render-path cosmetic swaps under Vanguard-protected LoL clients. (source: wiki/sources/descriptions/gmh5225__LeagueSkinChanger.md) LoL scripting/modding platforms such as [[leaguesharp]] (JungleTimerHax spectator jungle timers, SkinHax in-game skin changes, champion resize via LoL internal APIs; gmh5225) complement that lane for modular in-guest scripting under the same Vanguard-protected title. (source: wiki/sources/descriptions/gmh5225__LeagueSharp.md) LeagueSharp loader samples such as [[leaguesharp-loader]] (C#; DirectX + hooking; gmh5225) complement that lane for studying how scripting platforms bootstrap into the LoL client. (source: wiki/sources/descriptions/gmh5225__LeagueSharp.Loader.md) LeagueSharp champion plugin assemblies such as [[l-assemblies]] (C#; Orbwalker/TargetSelector combo scripts; ward/cooldown HUD tracker; gmh5225) complement that lane for studying automated gameplay logic in modular scripting plugins. (source: wiki/sources/descriptions/gmh5225__L-Assemblies.md)

## Related

[[easy-anti-cheat]] · [[battleye]] · [[hvci]] · [[byovd]] · [[xigmapper]] · [[augur-riot]] · [[vanguard-import-resolver]] · [[lol-patcher]] · [[lol-client]] · [[lol-offset-dumper]] · [[league-dumper]] · [[league-unpacker]] · [[lol-unpackman]] · [[league-base]] · [[r3nzskin-tft]] · [[league-skin-changer]] · [[leaguesharp]] · [[leaguesharp-loader]] · [[l-assemblies]] · [[hh-lol-prophet]] · [[frank]] · [[ayaya-league-external]] · [[lviewlol]] · [[valorant-dumper]] · [[valorant-dumper-tool]] · [[valorant-fnamepool]] · [[valorant-externals]] · [[valorant-esp-hack-with-driver]] · [[valo-driver]] · [[valorant-cheat-external]] · [[valorant-external]] · [[valorant-external-1]] · [[valorant-external-p2c-leaked]] · [[valorant-external-source]] · [[valorant-internal]] · [[valorant-internal-base]] · [[valorant-internal-cheat]] · [[valorant-cheat]] · [[valorant-cheat-internal]] · [[valorant-aimbot-bypass]] · [[valorant-esp-aimbot-hack]] · [[valorant-esp-aimbot-cheat-hack]] · [[valorant-hack-esp-aimbot-skinchanger]] · [[valorant-hack-esp-aimbot-skinchanger-source]] · [[valorantcc]] · [[vanguard-update-notifier]] · [[val-exception-handler]] · [[vgk-illegal-pf-logger]] · [[overviews/anti-cheat]]
