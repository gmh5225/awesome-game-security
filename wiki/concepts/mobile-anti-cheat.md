...
| Emulator / VM | Build fingerprint, sensors, FS signatures ([[anti-emulator]], [[android-emulator-detection]], [[conbeerlib]]); guest-Android sandboxes such as [[virtualmachine]] (syscall translation, chrooted rootfs; Magisk/Xposed instrumentation labs for AC behavior testing) (source: wiki/sources/descriptions/wumingzhinu__VirtualMachine.md) |
