...
Scoped as GCC RTTI–driven hierarchy/vtable recovery for IDA—not MSVC RTTI tooling. Complements [[pyclassinformer]] / [[rtti-parser]] (MSVC/script RTTI) and [[ida-vtable-tools]] (vtable skeleton export / slot indexing).
