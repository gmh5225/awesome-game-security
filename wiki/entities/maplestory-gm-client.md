...
**MapleStory Game Master client** (gmh5225) with admin-level functionality for private servers: map editing, NPC spawning, item creation, and other GM commands through a specialized client interface for server administration. (source: wiki/sources/descriptions/gmh5225__MapleStory-GM-Client.md)
...
- Repo: https://github.com/gmh5225/MapleStory-GM-Client (README tag: Offline MapleStory Client Emulator)
