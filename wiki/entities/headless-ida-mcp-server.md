...
Peers with other headless or agent-facing IDA bridges such as [[headless-ida]] (DennyDai; Python headless IDAPython toolkit; RPyC remote server; idat64/idalib; foundational script automation), [[tenrec]] (multi-session ida-domain + FastMCP; axelmierczuk), [[ida-mcp-rs]] (Rust headless MCP; blacktop), [[ida-rpc]] (JSON-RPC daemon; decompile/xrefs/types/patches; ghidra-rpc-compatible CLI; bkerler), [[ida-cli]] (idalib MCP; Rust/C++), [[ida-pro-mcp]] (full IDAPython MCP), [[mcp-server-idapro]] (AI-assistant bridge), and [[ida-mcp-server-plugin]] (disasm/decompile/xrefs MCP plugin).

## Links

- Repo: https://github.com/cnitlrt/headless-ida-mcp-server

## Related

[[overviews/reverse-engineering]] · [[overviews/game-hacking]] · [[headless-ida]] · [[ida-rpc]] · [[ida-cli]] · [[ida-pro-mcp]] · [[mcp-server-idapro]] · [[ida-mcp-server-plugin]] · [[binary-analysis-mcps]]
