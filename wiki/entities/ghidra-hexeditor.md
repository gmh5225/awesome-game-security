...
In-Ghidra byte editing complements standalone hex workbenches such as [[imhex]] and [[hexwalk]], and sits beside other Ghidra plugin tooling such as [[scalpel]] (ntdlll; Listing-synced dark-mode hex/ASCII grid, wildcard search, transaction patching; Java 21) (source: wiki/sources/descriptions/ntdlll__Scalpel.md), [[ghidra-findcrypt]] and [[ghidra-nativeaot]].
