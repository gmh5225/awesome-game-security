...
Build-tooling peer used by Gradle-based Ghidra extensions such as [[ghidra-orbis]] and [[ghidra-cpp-class-analyzer]] from the same maintainer; complements the full [[ghidra]] framework tree and runtime plugins ([[gfred]], [[dragonhook]], [[ghidra-mcp]]).
...
[[overviews/reverse-engineering]] · [[ghidra]] · [[ghidra-cpp-class-analyzer]] · [[ghidra-orbis]] · [[gfred]] · [[gui-plugin-template]]
