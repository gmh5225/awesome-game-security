...
Scoped as iOS kernelcache C++ vcall recovery—not general GCC RTTI hierarchy tooling ([[ida-medigate]]) or pip/cli kernelcache loading alone ([[ida-kernelcache-ng]]). Complements [[binja-kc]] (Binary Ninja MachO kernelcache / KDK dSYM loader) and [[aimachdec]] (LLM ARM64 Mach-O decompilation).
