...
Sits in the standalone KM+UM driver-primitives lane beside memory-access libraries such as [[ntmemory]] and [[readphys]], MouClass input research such as [[kernel-mouse]] and [[mouseclassservicecallbacktrick]], thread-evasion PoCs such as [[covert-thread]] and [[zero-thread-kernel]], NMI suppression samples such as [[nmi]] and [[disable-nmi-callbacks]], and pool-forensics context under [[kernel-pool-scanning]]. End-to-end external consumers from the same author — [[apex-external-cheat]] (DX11 ImGui), [[valorant-external-cheat]] (UE5/VGK), [[rust-external-cheat]] (DriverRW WDM + DX9 ImGui), and [[fortnite-external-cheat-base]] (UE SDK + CR3 bypass + DX11 ImGui) — illustrate driver-backed cross-process reads in title-specific overlay stacks.
...
[[overviews/windows-kernel]] · [[overviews/game-hacking]] · [[apex-external-cheat]] · [[valorant-external-cheat]] · [[rust-external-cheat]] · [[fortnite-external-cheat-base]] · [[ntmemory]] · [[readphys]] · [[kernel-mouse]] · [[mouseclassservicecallbacktrick]] · [[covert-thread]] · [[zero-thread-kernel]] · [[nmi]] · [[disable-nmi-callbacks]] · [[kernel-pool-scanning]]
