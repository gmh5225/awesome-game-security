...
Complements official PMU telemetry stacks such as [[intel-pcm]] and hardware-trace tooling ([[branch-monitoring-project]], [[libiht]], [[winipt]], [[windows-intel-pt]]) as a lightweight ETW-backed PMC lane rather than IPT control-flow capture.
...
[[intel-pcm]] · [[branch-monitoring-project]] · [[libiht]] · [[winipt]] · [[windows-intel-pt]] · [[processor-trace]] · [[overviews/windows-kernel]] · [[overviews/reverse-engineering]]
