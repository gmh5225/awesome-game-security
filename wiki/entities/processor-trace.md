...
Complements Windows IPT capture via [[winipt]] and [[windows-intel-pt]], Intel hardware-trace libraries such as [[libiht]], Intel-PT hypervisor fuzzing stacks such as [[qemu-nyx]], and ROP/JOP-oriented detection research such as [[pt-detector]] as the standard decode layer for raw PT buffers.
...
[[winipt]] · [[windows-intel-pt]] · [[pt-detector]] · [[libiht]] · [[qemu-nyx]] · [[branch-monitoring-project]] · [[overviews/reverse-engineering]] · [[overviews/windows-kernel]]
