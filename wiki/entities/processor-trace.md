...
Complements Windows IPT capture via [[winipt]], Intel hardware-trace libraries such as [[libiht]], and Intel-PT hypervisor fuzzing stacks such as [[qemu-nyx]] as the standard decode layer for raw PT buffers.
...
[[winipt]] · [[libiht]] · [[qemu-nyx]] · [[branch-monitoring-project]] · [[overviews/reverse-engineering]] · [[overviews/windows-kernel]]
