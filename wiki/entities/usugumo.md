...
Sits in the combined KM memory + input proxy lane beside [[driver-physical-rw]], [[norsefire]], and [[readwrite-kernel-stable]], and complements same-author usermode tooling such as [[mouse-input-injection]] and BYOVD injection research such as [[zhangbing-injector]].
...
[[driver-physical-rw]] · [[norsefire]] · [[readwrite-kernel-stable]] · [[km-um-communication]] · [[kernel-mouse]] · [[mouse-input-injection]] · [[zhangbing-injector]] · [[overviews/windows-kernel]] · [[overviews/game-hacking]]
