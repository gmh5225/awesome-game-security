...
Sits in the combined KM memory + input proxy lane beside [[driver-physical-rw]], [[norsefire]], and [[readwrite-kernel-stable]], and complements same-author usermode tooling such as [[mouse-input-injection]], BYOVD injection research such as [[zhangbing-injector]], and kernel-assisted CS2 externals such as [[ukia-rpm]].
...
[[driver-physical-rw]] · [[norsefire]] · [[readwrite-kernel-stable]] · [[km-um-communication]] · [[kernel-mouse]] · [[mouse-input-injection]] · [[zhangbing-injector]] · [[ukia-rpm]] · [[overviews/windows-kernel]] · [[overviews/game-hacking]]
