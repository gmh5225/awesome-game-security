...
Pairs with VEH page-protection samples such as [[no-access-protection]] (`PAGE_NOACCESS`) and [[voidmaw]] (`PAGE_GUARD`), and sleep-obfuscation PoCs such as [[death-sleep]] (thread terminate/restore) and [[shellcode-fluctuation]] (RW/NoAccess↔RX fluctuation), as alternate artifact-hiding strategies for AC memory-integrity research.
...
[[no-access-protection]] · [[voidmaw]] · [[death-sleep]] · [[shellcode-fluctuation]] · [[overviews/anti-cheat]] · [[overviews/reverse-engineering]]
