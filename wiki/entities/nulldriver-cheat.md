...
Mainly useful for reverse engineers studying **dxgkrnl export hooks**, structured user-kernel messaging, and GDI-assisted overlay or memory helpers in cheat drivers. Adjacent to [[dxgkrnl-hook]] (screen-buffer overlay research), sibling `NtDxgkGetTrackedWorkloadStatistics` hijack samples such as [[kernel-cheat-for-directx3d]] (gmh5225), composition-surface stealth I/O such as [[data-ptr-swap]] and [[double-callback]], and other non-IOCTL channels such as [[job-communication]] and [[r69-driver]].
...
[[dxgkrnl-hook]] · [[kernel-cheat-for-directx3d]] · [[data-ptr-swap]] · [[double-callback]] · [[job-communication]] · [[r69-driver]] · [[krnl-gdi-render]] · [[present-hook]] · [[overviews/windows-kernel]] · [[overviews/game-hacking]] · [[overviews/graphics-api]]
