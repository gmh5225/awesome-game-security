...
Complements agent-facing MCP bridges such as [[unity-mcp]] (Unity editor), [[deepwiki-mcp]] (docs/wiki retrieval), and [[memmcp]] (CE-like memory tooling) by targeting HITL prompts instead of engine, documentation, or process-memory surfaces.
...
[[overviews/overview]] · [[overviews/game-engine]] · [[unity-mcp]] · [[deepwiki-mcp]] · [[memmcp]]
