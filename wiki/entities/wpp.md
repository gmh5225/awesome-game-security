...
Sits in the Ring0 driver-hijack lane beside `.data` pointer swap research such as [[afd-irp-call-dispatch]], [[data-ptr-swap]], and [[driver-read-write]], and upstream to BTBD-derived HWID forks such as [[driver-hwid-btbd-modified]].
...
[[overviews/windows-kernel]] · [[overviews/game-hacking]] · [[driver-hwid-btbd-modified]] · [[afd-irp-call-dispatch]] · [[driver-read-write]] · [[easy-hwid-spoofer]] · [[hdd-serial-spoofer]]
