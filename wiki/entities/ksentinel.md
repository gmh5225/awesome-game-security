...
Complements offensive Linux LKM hook frameworks such as [[kernel-hook-framework]] and [[venom]], hidden-module discovery such as [[modreveal]], eBPF timing-anomaly rootkit research such as [[rootkit-detection-ebpf-time-trace]], and broader Linux runtime-security platforms such as [[tracee]].
...
[[modreveal]] · [[rootkit-detection-ebpf-time-trace]] · [[kernel-hook-framework]] · [[venom]] · [[tracee]] · [[vigil]] · [[overviews/anti-cheat]] · [[overviews/reverse-engineering]]
