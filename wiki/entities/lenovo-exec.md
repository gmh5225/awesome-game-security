...
Sibling gmh5225 projects on the same OEM driver include [[lenovo-mapper]] (manual unsigned driver map via memory-access IOCTLs) and other Lenovo OEM research such as [[lenovo-cve-2025-8061]] (`LnvMSRIO.sys` LPE) and [[phantomkiller]] (`BootRepair.sys` process kill).
...
[[byovd]] · [[lenovo-mapper]] · [[lenovo-cve-2025-8061]] · [[phantomkiller]] · [[pdfwkrnl-exploit]] · [[vdk]] · [[overviews/windows-kernel]] · [[overviews/anti-cheat]]
