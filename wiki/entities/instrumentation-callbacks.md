...
Complements syscall-return loggers such as [[instrumentation-callback-syscall-logger]] and hooking PoCs such as [[hooking-via-instrumentation-callback]] by emphasizing TLS recursion control and combined syscall/exception interception. Broader transition-coverage library PoCs such as [[instrumentation-callbacks-lib]] (1027565; syscall/APC/exception/user-mode-callback/thread-init) extend the same research lane. Pairs with kernel **PsAltSystemCallHandlers** monitors such as [[callmon]] and origin validators such as [[syscall-detect]] when comparing Ring3 callback telemetry vs kernel syscall paths.
...
[[overviews/windows-kernel]] · [[overviews/anti-cheat]] · [[overviews/reverse-engineering]] · [[instrumentation-callbacks-lib]] · [[instrumentation-callback-syscall-logger]] · [[hooking-via-instrumentation-callback]] · [[syscall-detect]] · [[callmon]] · [[nasty-alignment]] · [[beservice-intcallbacks]]
