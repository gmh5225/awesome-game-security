...
Frida-powered runtime exploration toolkit for iOS and Android with a web-based interface. TypeScript drives backend instrumentation services and a rich frontend for interactive mobile analysis. (source: wiki/sources/descriptions/ChiChou__grapefruit.md)
...
- Repo: https://github.com/ChiChou/grapefruit
