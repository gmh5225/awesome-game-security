...
Adjacent tooling: kernel-level root peer [[kernelsu]]; boot-image tools [[magiskboot]] and [[magiskboot-ndk-on-linux]]; Magisk modules such as [[move-certificate]] and Pixel-prop disguise [[easypixel]] (source: wiki/sources/descriptions/the-dise__EasyPixel.md); install paths such as [[cheese]]; detection samples such as [[magiskdetector]].
...
[[overviews/mobile-security]] · [[overviews/anti-cheat]] · [[overviews/game-hacking]] · [[kernelsu]] · [[magiskdetector]] · [[magiskboot]] · [[magiskboot-ndk-on-linux]] · [[move-certificate]] · [[easypixel]] · [[cheese]] · [[keyattestation]] · [[frida]]
