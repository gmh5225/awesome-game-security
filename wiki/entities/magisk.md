...
Adjacent tooling: boot-image unpack via [[magiskboot-ndk-on-linux]]; Magisk modules such as [[move-certificate]]; install paths such as [[cheese]]; detection samples such as [[magiskdetector]].
...
[[overviews/mobile-security]] · [[overviews/anti-cheat]] · [[overviews/game-hacking]] · [[magiskdetector]] · [[magiskboot-ndk-on-linux]] · [[move-certificate]] · [[cheese]] · [[keyattestation]] · [[frida]]
