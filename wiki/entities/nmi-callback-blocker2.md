...
Complements defensive NMI callback research such as [[nmi-callback]], register/trigger PoCs such as [[nmi-nmi-callback]], enumeration PoCs such as [[nmi-enum-nmi-callback]], alternate disable drivers such as [[disable-nmi-callbacks]] (KiNmiInterruptStart pattern scan + affinity/NMI-state patch), and sits beside broader [[kernel-callbacks]] manipulation tooling such as [[ps-notif-routine-unloader]] and [[rtoolz]].
...
[[nmi-callback]] · [[nmi-nmi-callback]] · [[nmi-enum-nmi-callback]] · [[disable-nmi-callbacks]] · [[kernel-callbacks]] · [[ps-notif-routine-unloader]] · [[rtoolz]] · [[overviews/windows-kernel]] · [[overviews/anti-cheat]] · [[overviews/reverse-engineering]]
