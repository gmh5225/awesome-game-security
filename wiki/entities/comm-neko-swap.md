...
Mainly useful for Windows kernel researchers studying non-IOCTL KM↔UM channels, win32k internal table abuse, and page-swap tradecraft for AC evasion — adjacent to [[comm-data-ptr-driver]], [[data-ptr-swap]], [[dataptrswap-driver]], and [[custom-data-ptr-swap-sample]].
