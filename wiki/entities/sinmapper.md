...
README tags the project under **Manual Map In Signed Driver** (armvirus). Complements signed-helper mappers such as [[cos-mapper]], pool-alloc mappers such as [[kdmapper]], and post-map cleanup tools such as [[nullmap]] and [[revert-mapper]]. Recon for oversized host sections via [[driver-dll-finder]].
...
[[cos-mapper]] · [[driver-dll-finder]] · [[kdmapper]] · [[nullmap]] · [[revert-mapper]] · [[saturn-mapper]] · [[known-driver-mappers]] · [[kernel-pool-scanning]] · [[byovd]] · [[overviews/windows-kernel]] · [[overviews/anti-cheat]]
