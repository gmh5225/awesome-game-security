---
title: anti-cheat-research-index
kind: entity
topics: [anti-cheat, windows-kernel, reverse-engineering, graphics-api]
sources:
...
- Anti-cheat architecture and defensive methodology
- Kernel execution, memory integrity, and attach/shellcode detection
- Graphics presentation-path integrity ([[present-hook]] detection lane)
- Intel VT-x / EPT hypervisor instrumentation
- x86/x64 reverse engineering and anti-debugging references

## Links

- Repo: https://github.com/xhscfq/anti-cheat-research-index
