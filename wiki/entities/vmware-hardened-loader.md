...
README lane: VMware guest fingerprint spoof under `Cheat > QEMU/KVM/PVE/VBOX` / `Detection:Virtual Environments` evasion research. Sibling focus to [[qemu-patched]] / [[proxmox-ve-anti-detection]] (QEMU/PVE spoof), lighter PowerShell analyst workflow [[vmware-cloak]], and defensive counterpart [[vmaware]] (100+ VM detection techniques).
