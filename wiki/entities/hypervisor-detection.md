...
Sits alongside Hyper-V VM environment probes such as [[go-detection-hyper-v]], kernel-mode KPCR/KPRCB Hyper-V guest probes such as [[detection-hyper-v]], ring-0 multi-heuristic test drivers such as [[detect-hypervisor-detect-ring-0]] (CPUID leaves, TSC/APERF/MPERF VM-exit timing, LBR/DEBUGCTL; manual-map print harness; gmh5225), IDT-based SIDT/LIDT probes such as [[hv-detect]], broad x86-64 HV/VMM detection collections such as [[hvdetecc]], user-mode HV probes such as [[checkhv-um]], EPT hook detectors such as [[ept-hook-detection]] (timing / write-compare / cross-core consistency), HV construction / stealth stacks such as [[hv]] and [[ophion]], and hacked-hypervisor stress tooling such as [[vt-debuuger]].
