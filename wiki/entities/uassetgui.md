...
Built on the [[uassetapi]] .NET library for UAsset binary parse/read/write. Sits in the README Game Assets / Unreal UAsset lane beside pak extractors such as [[paksmith]] and dependency-graph tooling such as [[jmap]], rather than live-process SDK dumps.
...
[[overviews/game-engine]] · [[overviews/reverse-engineering]] · [[uassetapi]] · [[jmap]] · [[paksmith]] · [[rust-u4pak]] · [[unreal-object-model]]
