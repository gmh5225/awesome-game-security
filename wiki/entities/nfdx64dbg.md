...
Not a standalone file triage tool—live module/file static ID inside [[x64dbg]], complementary to peers such as [[stringsx64dbg]] (string search/browse) and [[idenlibx]] (static-library function naming).
...
[[overviews/reverse-engineering]] · [[overviews/game-hacking]] · [[x64dbg]] · [[x64dbg-plugin-manager]] · [[stringsx64dbg]] · [[idenlibx]]
