...
Sits in the `Cheat > Spoof Stack` lane beside x64 trampoline implementations such as [[callstackspoofer-2]], reusable libraries such as [[spoof-stack-safecall]], x86 header-only samples such as [[x86-ret-spoof]], and the complementary exception-handler-based PoC [[exception-ret-spoofing]] from the same author.
...
[[stack-spoofing]] · [[exception-ret-spoofing]] · [[callstackspoofer-2]] · [[x86-ret-spoof]] · [[return-address-spoofer]] · [[vpgather]] · [[overviews/game-hacking]] · [[overviews/anti-cheat]]
