...
Sits beside broader [[kernel-callbacks]] research (process/image/Ob notify), related gmh5225 NMI PoCs such as [[nmi-nmi-callback]] (register/trigger), [[nmi-enum-nmi-callback]] (enumerate), and [[nmi-callback-blocker2]] (disable), and complements hacked-hypervisor detectors such as [[hypervisor-detection]], benchmark suites such as [[nohv]], and AMD SVM stress tooling such as [[baresvm]].
...
[[overviews/anti-cheat]] · [[overviews/windows-kernel]] · [[kernel-callbacks]] · [[nmi-nmi-callback]] · [[nmi-enum-nmi-callback]] · [[nmi-callback-blocker2]] · [[hypervisor-detection]] · [[nohv]] · [[baresvm]] · [[checkhv-um]] · [[hvci]]
