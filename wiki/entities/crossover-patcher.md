...
Sits in the macOS **Wine / CrossOver compatibility** lane beside GNU/Linux **Proton/Wine** workflows tracked by [[are-we-anti-cheat-yet]] and userspace AC-driver study samples such as [[holodori-kernel-bypass]], but focuses on host-runtime patching rather than in-game cheat tooling.
...
[[are-we-anti-cheat-yet]] · [[holodori-kernel-bypass]] · [[elden-ring-ct-tga]] · [[ptrace-read-teb]] · [[overviews/anti-cheat]] · [[overviews/game-hacking]]
