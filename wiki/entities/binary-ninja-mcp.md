...
Peers with IDA-side agent RE via [[ida-pro-mcp]] / [[ida-mcp-server-plugin]] / [[iida-mcp]] and Ghidra MCP via [[ghidra-headless-mcp]] / [[ghidrassist-mcp]]. CLI-oriented agent access via [[bn]] (banteg; Python CLI for Binary Ninja agents) offers a complementary transport in the same lane. Complements Binary Ninja plugin work such as [[binaryninja-pcode]], [[ariadne]], and [[obfuscation-analysis]] inside the same disassembler.
...
[[overviews/reverse-engineering]] · [[overviews/game-hacking]] · [[bn]] · [[ida-pro-mcp]] · [[ghidra-headless-mcp]] · [[binaryninja-pcode]] · [[cheatengine-mcp-bridge]] · [[memmcp]]
