...
Complements header-only experiment corpora such as [[integrity-experiments]], pointer/vtable integrity PoCs such as [[pointer-guard]], VEH + page-protection samples such as [[voidmaw]] and [[no-access-protection]], and Byfron-style PoCs such as [[page-no-access-not-byfron]].
...
[[integrity-experiments]] · [[pointer-guard]] · [[voidmaw]] · [[no-access-protection]] · [[page-no-access-not-byfron]] · [[veh-hide-memory]] · [[pghooker]] · [[overviews/anti-cheat]] · [[overviews/windows-kernel]]
