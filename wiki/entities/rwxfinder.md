...
Complements injection tradecraft collections such as [[windows-process-injection]] and defensive RWX scanners such as [[ghost]], [[rwxscanner]], and [[rasd]]. Sibling low-footprint injector [[frankenstein-apc-injection]] reuses discovered RWX regions with `NtQueueApcThreadEx2` APC delivery.
