...
Complements live OS-side acquirers such as [[dumpit-mirror]] and [[tool-diy-system-memory-dump]], and USB-boot UEFI RAM dump apps such as [[memory-dump-uefi]], in the offline memory-forensics lane, but captures from **firmware DXE** rather than a running Windows kernel or a standalone UEFI shell session.
...
[[dumpit-mirror]] · [[tool-diy-system-memory-dump]] · [[memory-dump-uefi]] · [[eficmake]] · [[minivisorpkg]] · [[volatility]] · [[volatility3]] · [[overviews/windows-kernel]] · [[overviews/reverse-engineering]]
