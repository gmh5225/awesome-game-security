...
Complements Delphi-adjacent cheat/RE workflows such as [[ce-remap-plugin]] (Delphi Cheat Engine plugin) and unpackers with Delphi OEP heuristics such as [[magicmida-rs]] when static IDA analysis needs Delphi-specific structure recovery.
