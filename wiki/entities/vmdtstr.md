...
Complements IDT SIDT/LIDT probes such as [[hv-detect]], ring-0 multi-heuristic test drivers such as [[detect-hypervisor-detect-ring-0]], multi-technique C++ detectors such as [[hypervisor-detection]], broad x86-64 HV/VMM detection collections such as [[hvdetecc]], REP MOV / ERMSB EPT side-channel probes such as [[ermsb-meme]], and hypervisor VM-detection benchmarking such as [[nohv]].
