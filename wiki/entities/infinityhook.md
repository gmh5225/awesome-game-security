...
Downstream C++ wrappers such as [[etwhook-infinityhookclass]] and evolved frameworks such as [[infinityhook-promax]] package the same ETW-backed hook surface for reuse; complements ETW syscall modding samples such as [[etw-syscall]], passive EtwTi loggers such as [[etw-syscall-monitor]], and Instrumentation Callback hook PoCs such as [[etwti-syscall-hook]].
...
[[overviews/windows-kernel]] · [[overviews/anti-cheat]] · [[etw-threat-intelligence]] · [[patchguard]] · [[etwhook-infinityhookclass]] · [[infinityhook-promax]] · [[etw-syscall]] · [[etw-syscall-monitor]] · [[etwti-syscall-hook]] · [[ermsb-meme]]
