...
Adjacent to sibling dxgkrnl export-hook samples such as [[comm-im-miraclela]] (EFT ImGui overlay + same `NtDxgkGetTrackedWorkloadStatistics` channel), [[nulldriver-cheat]] (`NtOpenCompositionSurfaceSectionInfo` covert comms + GDI helpers), [[dxgkrnl-hook]] (screen-buffer overlay research), and kernel GDI frameworks such as [[krnl-gdi-render]].
...
[[dxgkrnl-hook]] · [[comm-im-miraclela]] · [[nulldriver-cheat]] · [[krnl-gdi-render]] · [[double-callback]] · [[present-hook]] · [[overviews/windows-kernel]] · [[overviews/graphics-api]] · [[overviews/game-hacking]]
