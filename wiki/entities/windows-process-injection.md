...
Contrasts with focused samples such as [[modexmap]] (UM PE manual-map), [[hintinject]] (import-table Hint/Name Table shellcode staging), [[injectors]] (injection-testing harness), [[jektor]] (shellcode execution vectors + dynamic resolve + XOR/NOP-sled payloads), [[kinject]] / [[injdrv]] (kernel APC paths), and stack-spoof illustrations such as [[return-address-spoofer]].
...
[[overviews/game-hacking]] · [[overviews/anti-cheat]] · [[injectors]] · [[modexmap]] · [[hintinject]] · [[kinject]] · [[injdrv]] · [[return-address-spoofer]] · [[tietwagent]]
