...
Complements IDA-side Delphi analysis such as [[delphi-helper]] and [[ida-for-delphi]] (runtime event-constructor naming) and Ghidra automation such as [[ghidra-scripts]] and [[better-string-analyzer]] when static Ghidra workflows need Object Pascal symbol context instead of raw addresses.
