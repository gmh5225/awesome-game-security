...
Adjacent to kernel DWM/composition samples such as [[double-callback]] and [[data-ptr-swap]], Win11 Null-pattern dxgkrnl export hooks such as [[nulldriver-cheat]] (`NtOpenCompositionSurfaceSectionInfo` covert comms + optional GDI helpers; gmh5225), `NtDxgkGetTrackedWorkloadStatistics` hijack samples such as [[kernel-cheat-for-directx3d]] (gmh5225; graphics-syscall command dispatcher + KM GDI draw), and to user-mode [[present-hook]] / overlay detection surfaces under [[overviews/graphics-api]].
...
[[present-hook]] · [[nulldriver-cheat]] · [[kernel-cheat-for-directx3d]] · [[double-callback]] · [[data-ptr-swap]] · [[eac-overlay]] · [[overviews/graphics-api]] · [[overviews/windows-kernel]] · [[overviews/game-hacking]]
