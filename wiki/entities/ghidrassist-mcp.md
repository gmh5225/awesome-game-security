...
Ghidra-side peer to [[ghidra-headless-mcp]] (headless 40+ tool server) and IDA MCP bridges such as [[ida-pro-mcp]] / [[ida-mcp-server-plugin]]—this path exposes Ghidra through MCP for agent-driven RE rather than a standalone headless CLI. Same maintainer as [[gdb-mcp]] and in-IDA [[idassist]].
...
[[overviews/reverse-engineering]] · [[overviews/game-hacking]] · [[ghidra-headless-mcp]] · [[ghidra-bridge]] · [[ida-pro-mcp]] · [[gdb-mcp]] · [[idassist]]
