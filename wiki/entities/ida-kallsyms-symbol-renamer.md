...
Complements offline symbol recovery via [[vmlinux-to-elf]] (kallsyms embedded in raw kernel images) and Windows-side MAP import plugins such as [[ida-map-symbol-parser]] and [[ida-pro-loadmap]]. Useful when analyzing a kernel image on a live or matching build where `/proc/kallsyms` is available.
...
[[overviews/reverse-engineering]] · [[vmlinux-to-elf]] · [[ida-map-symbol-parser]] · [[ida-pro-loadmap]] · [[venom]] · [[list-of-ida-plugins]]
