...
Scoped as IDA vtable annotation/export tooling—not a full RTTI/SDK generator. Complements type-metadata helpers such as [[rtti-parser]] and iOS vtable-aware helpers such as [[ida-ios-helper]].
