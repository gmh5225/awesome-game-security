...
Contrasts with leaked-cert signers such as [[magic-signer]] and expiry-bypass sideloads such as [[sign-expired]]: here the focus is synthesizing fake cert material from Microsoft SDK tooling, not transplanting real signatures ([[sigthief]]) or patching signed PE certificate tables ([[sigflip]]).
