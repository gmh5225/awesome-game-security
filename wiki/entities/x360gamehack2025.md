...
Open-source Windows **all-in-one desktop app** (C# / .NET Framework, WinForms) for installing and managing personally backed-up games on **Xbox 360** RGH/JTAG, Bad Update, Bad Avatar, and devkit consoles, with additional support for **original Xbox** ISO and XBE files. (source: wiki/sources/descriptions/IcyModz420__X360GameHack2025.md)
...
- Repo: https://github.com/IcyModz420/X360GameHack2025 (README tag: Xbox 360/OG Xbox all-in-one XEX/XBE/XISO/PKG/GOD patching tool for RGH/JTAG and Bad Update)
