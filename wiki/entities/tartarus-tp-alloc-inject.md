...
Contrasts with broader injection catalogs such as [[windows-process-injection]] (includes thread-pool / fiber / syscall samples), user-mode PE manual-map injectors such as [[modexmap]], and injection-testing harnesses such as [[injectors]]. Kernel APC inject counterparts: [[injdrv]] / [[kinject]].
...
[[overviews/game-hacking]] · [[overviews/anti-cheat]] · [[windows-process-injection]] · [[modexmap]] · [[injectors]] · [[injdrv]] · [[kinject]]
