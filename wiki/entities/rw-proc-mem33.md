...
Upstream project for forks such as [[rwmem]]; sits in the same Android root / kernel memory-ops lane as [[root-socket-kit]], [[kernel-hack]], and CLI scanners such as [[mypower]].
...
[[overviews/mobile-security]] · [[overviews/game-hacking]] · [[rwmem]] · [[root-socket-kit]] · [[kernel-hack]] · [[mypower]] · [[android-kernel-hacking-toolkit]] · [[compile-android-driver]]
