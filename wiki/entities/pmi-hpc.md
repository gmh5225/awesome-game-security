...
Complements passive PMC profiling via [[pmctrace]] and branch-trace collection via [[branch-monitoring-project]] as an interrupt-driven HPC lane oriented toward exploit-pattern detection rather than ETW streaming or LBR/BTS control-flow capture.
...
[[pmctrace]] · [[branch-monitoring-project]] · [[intel-pcm]] · [[libiht]] · [[overviews/windows-kernel]] · [[overviews/reverse-engineering]]
