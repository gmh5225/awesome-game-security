...
Sits in the Anti Cheat `Detection:Magisk` / Android-root lane opposite the canonical [[magisk]] framework, alongside Magisk install and hide tooling such as [[cheese]], [[move-certificate]], and [[magiskboot-ndk-on-linux]]. Same-author hardware attestation sample: [[keyattestation]].
...
[[overviews/mobile-security]] · [[overviews/anti-cheat]] · [[magisk]] · [[frida]] · [[keyattestation]] · [[cheese]] · [[move-certificate]] · [[magiskboot-ndk-on-linux]]
