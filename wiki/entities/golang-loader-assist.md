...
In-IDA workflow in the Go symbol-recovery lane: complements stepwise IDAPython analysis scripts such as [[alphagolang]], offline pclntab/moduledata extractors such as [[goresym]], and hands-on Go RE curriculum [[go-hacking]] when analysts need symbols and types applied directly inside an IDA database.
...
[[overviews/reverse-engineering]] · [[overviews/game-hacking]] · [[alphagolang]] · [[goresym]] · [[go-hacking]] · [[idaplugins-list]] · [[ida-rust-demangler]]
