...
Research lane: **low-level Windows crash-mechanism** study and demonstration of **kernel patching** on the bugcheck path—not a production stability tool. Part of the NSG650 bugcheck-research family alongside suppression PoCs such as [[nomore-bugcheck]] and visual crash hacks.
