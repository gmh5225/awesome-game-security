...
Sits in the ring-0 CS 1.6 lane beside user-mode samples such as [[oxware]], [[hpp-hack]], and [[ezfrags]], and full-kernel CS:GO frameworks such as [[csgo-full-kernel]] and [[raybot-zero]]. Technique-wise it bridges [[kernel-gdi-draw]] / [[kernel-drawing]] GDI render paths and [[mouhid-input-hook]] MouHid ClassService interception for combined ESP + aimbot from one driver.
...
[[oxware]] · [[hpp-hack]] · [[ezfrags]] · [[csgo-full-kernel]] · [[kernel-gdi-draw]] · [[kernel-drawing]] · [[mouhid-input-hook]] · [[kernel-mouse]] · [[zero-thread-kernel]] · [[overviews/game-hacking]] · [[overviews/windows-kernel]]
