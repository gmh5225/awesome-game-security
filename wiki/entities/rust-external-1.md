...
Complements in-process scaffolds such as [[rust-internal]] and minimal title-specific sources [[simple-rust-hack]], the rendering/networking external sample [[rust-external]], driver/shader/audio external source [[rust-external-source]], driver/overlay/memory-analysis external sample [[rust-external-and-driver-aliencheats]], plus the OOP driver/rendering base [[simple-rust-base]], for comparing external kernel/RPM + overlay ESP vs internal DX11/ImGui hooks under [[easy-anti-cheat]].
...
[[rust-external]] · [[rust-external-source]] · [[rust-external-and-driver-aliencheats]] · [[rust-internal]] · [[simple-rust-hack]] · [[simple-rust-base]] · [[world-to-screen]] · [[il2cpp]] · [[easy-anti-cheat]] · [[overviews/game-hacking]] · [[overviews/windows-kernel]]
