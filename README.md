...
- https://github.com/brendan-duncan/gpu_inspector [Native GPU frame capture and graphics debugger for Vulkan, Direct3D 12, and Metal with shader editing, pixel history, and validation]
...
- https://github.com/ngwg/ceasta [Integrated disassembler, decompiler, and x64dbg-style debugger for Windows and Linux with Lua plugins and a built-in MCP server for AI-assisted binary analysis]
...
- https://github.com/kEv1nZ0/VTD-Bypass [VT-d/IOMMU]
...
- https://github.com/Kryx7z/Conglomerate-Cs2 [Open-source internal Counter-Strike 2 cheat in C++ (TempleWare-based) with Visual Studio build and DLL injection workflow]
...
- https://github.com/IZxMD/ac-compat-research [Vendor-agnostic feasibility study on hosting kernel anti-cheat components on Linux without virtualization, covering LSM, signing, isolation, and ABI constraints]
...
- https://github.com/AbdulAmi09/SentinelAntiCheat [Chess integrity platform with seven-layer statistical engine-assistance detection, explainable risk tiers, arbiter case management, and hash-chained audit logging]
...
- https://github.com/RabehX/Securify [Open-source Android app auditing Magisk/KernelSU modifications and Play Integrity API attestation with device fingerprint and security-patch reporting]
