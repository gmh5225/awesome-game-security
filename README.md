...
- https://github.com/BUNNY-19C/DLSSG-30s-manager [WPF manager for per-game dlssg_for_sm86 deployment on RTX 30 (SM86), with backups, restore, and automatic kernel anti-cheat detection that blocks unsafe installs]
...
- https://github.com/Coldzer0/RE4F [Obsidian-based reverse-engineering curriculum covering x86/x64 assembly, Windows memory and PE internals, static/dynamic analysis, and anti-analysis (packing, anti-debug)]
...
- https://github.com/savagedamage/android-security-wizard [Integrated Android security research corpus (SKILL.md + 20 companions) covering native RE, Frida/Shizuku instrumentation, commercial protector bypass, kernel exploit methodology, and malware triage]
...
- https://github.com/zensu357/ksurusda [Zygisk module injecting Rusda anti-detection Frida gadget on KernelSU, Magisk, or APatch with WebUI, listen/offline script modes, and library remapping]
...
- https://github.com/xposed-modules-repo/com.fuck.iab [LSPosed/Xposed module that hooks Google Play, Bazaar, and Myket in-app billing to bypass purchases, with per-package Frida script support]
...
- https://github.com/RytterMohn/UsbDetectionBypass [LSPosed/Xposed module that hides in-app USB connection and USB debugging detection signals (Settings/SystemProperties, USB broadcasts, UsbManager, getprop/dumpsys, sysfs)]
...
- https://github.com/seifreed/xrefgen [IDA Pro cross-reference generator for indirect refs and complex control-flow, with XRefer-compatible output]
...
- https://github.com/xp987/symbridge [Live IDA ↔ x64dbg annotation and type synchronization bridge]
...
- https://github.com/mrexodia/ida-pro-mcp [MCP for IDA pro]
- https://github.com/bkerler/ida_rpc [JSON-RPC daemon for agent-assisted RE: decompile, disassemble, xrefs, rename, types, patches; headless & GUI]
- https://github.com/saileaxh/iida-mcp [Faster IDA Pro MCP plugin — 77 tools, multi-instance routing, optional Windows kernel memory/module access via iida-mcp-ioctl driver]
- https://github.com/MeroZemory/ida-multi-mcp [Multi-instance IDA Pro MCP: one endpoint for many GUI/idalib sessions; parallel routing; BCSD function similarity; Python]
- https://github.com/MxIris-Reverse-Engineering/ida-mcp-server [MCP for IDA pro]
- https://github.com/taida957789/ida-mcp-server-plugin [MCP for IDA pro]
...
- https://github.com/ntdlll/Scalpel [Ghidra extension for dockable dark-mode hex/ASCII viewing, wildcard hex search, and inline byte patching during RE]
...
- https://github.com/xp987/symbridge [Live IDA ↔ x64dbg annotation and type synchronization bridge]
- https://github.com/CynicRus/DWARFHelper [Load DWARF debug symbols from PE (.exe/.dll) as labels, functions, and file:line comments; libdwarf; x86/x64]
...
- https://github.com/lyk64/VolkDMA [C++ DMA library for FPGA memory R/W, scatter I/O, module dumps, signature scans, CR3 fix, and kernel-derived input state (LeechCore/MemProcFS based)]
- https://github.com/ekknod/vm [Minimal memory library for Windows/Linux]
- https://github.com/gmh5225/ReClass-DMA [ReClass DMA]
- https://github.com/Metick/CheatEngine-DMA [CheatEngine DMA]
- https://github.com/kaijia2022/Cheat-Engine-DMA-Plugin [CheatEngine DMA]
...
- https://github.com/Dray973/Aetheris [PyQt6 Windows forensics suite with PCILeech-FPGA physical memory read/write via MemProcFS, process autopsy, and audited reversible actions]
...
- https://github.com/sercanarga/pcileechgen [Go tool to clone a real PCI/PCIe donor via VFIO and synthesize ready-to-flash PCILeech FPGA bitstreams through Vivado]
...
- https://github.com/brandenbailey23/r6-siege-battleye-launch-bug [Documented R6 Siege Y11S3 BattlEye/Sentinel handshake failure on standard launch paths, with timeline, driver load evidence, and working bypass via RainbowSixHelper.exe]
...
- https://github.com/ilia810/MapleUnity [Unity reimplementation of MapleStory v83 client; TDD + clean architecture; C#; NX assets]
- https://github.com/ppodds/UniStory [Unity MapleStory emulator (WIP); target TMS v245; C#; WZ maps/footholds/physics; no server yet]
- https://github.com/MapleStoryUnity/MapleStoryUnity [Unity framework for MapleStory-style MMORPGs; C#; WZ via UnityWzLib; GPL-3.0]
...
- https://github.com/Valthrun/Valthrun_PUBG [External read-only kernel-based gameplay enhancer in Rust; requires Zenith driver; radar/ESP/health/distance]
...
- https://github.com/u8012146108-bit/anticheat-qa [Fabric 1.21 client mod for anti-cheat QA—observes, visualizes, logs, and simulates server-side detections without enabling cheats]
...
- https://github.com/noahware/armcall [Header-only ARM64 Windows direct syscall library that extracts SVC immediates from ntdll exports to bypass hooked user-mode APIs]
...
> Obfuscation Engine
- https://github.com/killvxk/awesome-obfuscations [Curated index of binary, compile-time, and LLVM/GCC obfuscation tools]
- https://github.com/DosX-dev/obfus.h [Macro-header for compile-time C obfuscation (tcc, win x86/x64)]
...
- https://github.com/zhurong2020/pyobfus [AST-based Python obfuscator with reverse stack-trace mapping and MCP server]
...
- https://github.com/vxlang/vxlang-page [Windows x86-64/.NET binary protector with obfuscation, code virtualization, and anti-tamper (PE/DLL/SYS)]
...
- https://github.com/TheCruZ/nvidiaCapture [NVIDIA Scanout]
- https://github.com/vmguard/dwm-window-capture [DWM Redirect]
...
- https://github.com/TheMille-Dev/AntiGuard [Self-contained Paper/Purpur Minecraft anti-cheat plugin with Fly/Speed/Reach/KillAura checks, embedded SQLite storage, and built-in web dashboard plus REST API]
- https://github.com/boondocksulfur/bs-anticheat [Lightweight Paper/Folia Minecraft anti-cheat with movement, combat, world, inventory, and packet checks plus SQLite logging]
...
- https://github.com/0x6461726B/Hook-Detector [Windows usermode inline and IAT hook detector using remote PE parsing and manual PEB traversal]
...
- https://github.com/talsec/Free-RASP-Community [Community hub for the freeRASP mobile RASP SDK (root/Magisk, Frida, hook, emulator, tamper, and integrity detection)]
...
- https://github.com/aeterna/aeterna-rongroi [Offline, open-source FiveM PC-check tool that surfaces cheat traces and risky machine posture as evidence without issuing clean/guilty verdicts]
...
- https://github.com/zqxwce/vphone-ws [Native macOS SwiftUI front-end for vphone-cli: browse, create, and boot iOS research VMs from a single window]
- https://github.com/34306/vphone-aio [1 script run the vphone]
- https://github.com/jprx/darwin-vm [QEMU Darwin VM: boot iOS/macOS to root shell; virtual iPhone 17–12 (A19–A14) and M5–M1 Apple Silicon Macs; kernel/SPTM/TXM debug; no GUI/SpringBoard]
...
- https://github.com/ntfargo/CSSFontFace-Exploit [WebKit CSSFontFace UAF for PS4/PS5; PS4 6.00-11.02 (kernel chain 7.00-11.02); PS5 needs separate ASLR/vtable defeat; writeup: linearfox.com]
...
- [SYM 2675](https://vintage-angel-symbols-66.pages.dev/symbol/sym-2675/)
- [SYM 1F914](https://mecha-blade-symbols-46.pages.dev/symbol/sym-1f914/)
...
- [SYM 1D443](https://coquette-symbols.pages.dev/symbol/sym-1d443/)
- [SYM 1F60D](https://vintage-library-rune-80.pages.dev/symbol/sym-1f60d/)
- [BIOHAZARD SYMBOL](https://gothic-bio-fonts-13.pages.dev/symbol/biohazard-symbol/)
- [SYM 2612](https://gothic-bio-fonts-13.pages.dev/symbol/sym-2612/)
- [SYM 26C1](https://nordic-minimal-fonts-67.pages.dev/symbol/sym-26c1/)
- [FOUR POINT STAR SPARKLE](https://angelic-bow-symbols-42.pages.dev/symbol/four-point-star-sparkle/)
- [CHEERING FIGHTING FIST KAOMOJI](https://coquette-symbols.pages.dev/symbol/cheering-fighting-fist-kaomoji/)
- [SYM 26B0](https://theeduplaycampen.pages.dev/symbol/sym-26b0/)
- [SYM 2680](https://coquette-symbols.pages.dev/symbol/sym-2680/)
- [SYM 2673](https://coquette-symbols.pages.dev/symbol/sym-2673/)
- [SYM 26AD](https://coquette-symbols.pages.dev/symbol/sym-26ad/)
- [SYM 1D44D](https://gothic-bio-fonts-13.pages.dev/symbol/sym-1d44d/)
- [SYM 26E5](https://nordic-minimal-fonts-67.pages.dev/symbol/sym-26e5/)
- [SYM 2670](https://matrix-hacker-text-52.pages.dev/symbol/sym-2670/)
- [SYM 2748](https://matrix-hacker-text-52.pages.dev/symbol/sym-2748/)
- [WATER BUBBLES](https://vintage-library-rune-80.pages.dev/symbol/water-bubbles/)
- [SYM 2674](https://coquette-symbols.pages.dev/symbol/sym-2674/)
- [SYM 267D](https://coquette-symbols.pages.dev/symbol/sym-267d/)
- [SYM 1D42D](https://nordic-minimal-fonts-67.pages.dev/symbol/sym-1d42d/)
- [SYM 1F634](https://theeduplaycampen.pages.dev/symbol/sym-1f634/)
- [SYM 262E](https://coquette-symbols.pages.dev/symbol/sym-262e/)
- [STARRY ELEVATION AURA](https://matrix-hacker-text-52.pages.dev/symbol/starry-elevation-aura/)
- [SYM 26FE](https://nordic-minimal-fonts-67.pages.dev/symbol/sym-26fe/)
- [INSTAGRAM BIO](https://vintage-library-rune-80.pages.dev/es/instagram-bio/)
- [SYM 1D4A1](https://neon-glitch-symbols-84.pages.dev/symbol/sym-1d4a1/)
- [SYM 2634](https://theeduplaycampen.pages.dev/symbol/sym-2634/)
- [SYM 1D403](https://gothic-bio-fonts-13.pages.dev/symbol/sym-1d403/)
- [SYM 260E](https://matrix-hacker-text-52.pages.dev/symbol/sym-260e/)
- [SYM 1F92A](https://coquette-symbols.pages.dev/symbol/sym-1f92a/)
- [MUSIC WEATHER](https://theeduplaycampen.pages.dev/ru/music-weather/)
- [SYM 26CB](https://neon-glitch-symbols-84.pages.dev/symbol/sym-26cb/)
- [SYM 262F](https://coquette-symbols.pages.dev/symbol/sym-262f/)
- [NATURE FLOWERS](https://theeduplaycampen.pages.dev/es/nature-flowers/)
- [SYM 267C](https://gothic-bio-fonts-13.pages.dev/symbol/sym-267c/)
- [LITTLE CAT PAWS KAOMOJI](https://coquette-symbols.pages.dev/symbol/little-cat-paws-kaomoji/)
- [SYM 273D](https://matrix-hacker-text-52.pages.dev/symbol/sym-273d/)
- [SYM 1D412](https://nordic-minimal-fonts-67.pages.dev/symbol/sym-1d412/)
- [SYM 2636](https://coquette-symbols.pages.dev/symbol/sym-2636/)
- [SYM 2721](https://gothic-bio-fonts-13.pages.dev/symbol/sym-2721/)
- [DOWNWARD DIAGONAL ARROW](https://coquette-symbols.pages.dev/symbol/downward-diagonal-arrow/)
- [SYM 26AA](https://nordic-minimal-fonts-67.pages.dev/symbol/sym-26aa/)
- [ZODIAC CELESTIAL](https://theeduplaycampen.pages.dev/zodiac-celestial/)
- [SYM 1F920](https://gothic-bio-fonts-13.pages.dev/symbol/sym-1f920/)
- [KAOMOJI](https://minimal-star-symbols-93.pages.dev/ja/kaomoji/)
- [SYM 274B](https://matrix-hacker-text-52.pages.dev/symbol/sym-274b/)
- [SYM 26A6](https://coquette-symbols.pages.dev/symbol/sym-26a6/)
- [MUSIC WEATHER](https://coquette-symbols.pages.dev/music-weather/)
- [OPEN CENTRE STAR](https://coquette-symbols.pages.dev/symbol/open-centre-star/)
- [SYM 2685](https://minimal-star-symbols-93.pages.dev/symbol/sym-2685/)
- [GEMINI ZODIAC TWINS](https://matrix-hacker-text-52.pages.dev/symbol/gemini-zodiac-twins/)
- [BRACKETS](https://coquette-symbols.pages.dev/ja/brackets/)
- [HIGH VOLTAGE LIGHTNING](https://angelic-bow-symbols-42.pages.dev/symbol/high-voltage-lightning/)
- [SYM 1F917](https://minimal-star-symbols-93.pages.dev/symbol/sym-1f917/)
- [FLORAL BRANCH BOUQUET](https://coquette-symbols.pages.dev/symbol/floral-branch-bouquet/)
- [SYM 1FAE1](https://coquette-symbols.pages.dev/symbol/sym-1fae1/)
- [STARS](https://angelic-bow-symbols-42.pages.dev/es/stars/)
- [SYM 1D44C](https://coquette-aesthetic-symbols-86.pages.dev/symbol/sym-1d44c/)
- [STARS](https://angelic-bow-symbols-42.pages.dev/pt/stars/)
- [FLORAL BRANCH BOUQUET](https://vintage-library-rune-80.pages.dev/symbol/floral-branch-bouquet/)
- [SYM 268D](https://nordic-minimal-fonts-67.pages.dev/symbol/sym-268d/)
- [SYM 2679](https://angelic-bow-symbols-42.pages.dev/symbol/sym-2679/)
- [SYM 2641](https://angelic-bow-symbols-42.pages.dev/symbol/sym-2641/)
- [SYM 26C2](https://nordic-minimal-fonts-67.pages.dev/symbol/sym-26c2/)
- [ROBLOX NAMES](https://theeduplaycampen.pages.dev/vi/roblox-names/)
- [SKULL AND CROSSBONES](https://angelic-bow-symbols-42.pages.dev/symbol/skull-and-crossbones/)
- [SYM 2647](https://angelic-bow-symbols-42.pages.dev/symbol/sym-2647/)
- [BRACKETS](https://theeduplaycampen.pages.dev/pt/brackets/)
- [FREEFIRE NAMES](https://theeduplaycampen.pages.dev/freefire-names/)
- [HEARTS](https://theeduplaycampen.pages.dev/hearts/)
- [SYM 1D470](https://coquette-aesthetic-symbols-86.pages.dev/symbol/sym-1d470/)
- [SYM 1F922](https://minimal-star-symbols-93.pages.dev/symbol/sym-1f922/)
- [SYM 1D4A0](https://coquette-aesthetic-symbols-86.pages.dev/symbol/sym-1d4a0/)
- [SYM 1D495](https://gothic-bio-fonts-13.pages.dev/symbol/sym-1d495/)
- [SYM 2647](https://coquette-symbols.pages.dev/symbol/sym-2647/)
- [SYM 1D417](https://angelic-bow-symbols-42.pages.dev/symbol/sym-1d417/)
- [SYM 2678](https://gothic-bio-fonts-13.pages.dev/symbol/sym-2678/)
- [SHADOWED WHITE STAR](https://theeduplaycampen.pages.dev/symbol/shadowed-white-star/)
- [SYM 1F499](https://angelic-bow-symbols-42.pages.dev/symbol/sym-1f499/)
- [SYM 1D41B](https://nordic-minimal-fonts-67.pages.dev/symbol/sym-1d41b/)
- [SYM 1D442](https://theeduplaycampen.pages.dev/symbol/sym-1d442/)
- [SYM 2662](https://matrix-hacker-text-52.pages.dev/symbol/sym-2662/)
- [SYM 1D48E](https://neon-glitch-symbols-84.pages.dev/symbol/sym-1d48e/)
- [SYM 26C0](https://nordic-minimal-fonts-67.pages.dev/symbol/sym-26c0/)
- [SYM 1D450](https://coquette-aesthetic-symbols-86.pages.dev/symbol/sym-1d450/)
- [SYM 2675](https://coquette-symbols.pages.dev/symbol/sym-2675/)
- [TRENDING](https://matrix-hacker-text-52.pages.dev/ru/trending/)
- [SYM 1D40A](https://nordic-minimal-fonts-67.pages.dev/symbol/sym-1d40a/)
- [BORDERS DIVIDERS](https://vintage-library-rune-80.pages.dev/vi/borders-dividers/)
- [FREEFIRE NAMES](https://theeduplaycampen.pages.dev/ru/freefire-names/)
- [WHITE STAR](https://theeduplaycampen.pages.dev/symbol/white-star/)
- [SYM 260D](https://matrix-hacker-text-52.pages.dev/symbol/sym-260d/)
- [SYM 1F49F](https://angelic-bow-symbols-42.pages.dev/symbol/sym-1f49f/)
- [GREEK PSI TRIDENT](https://matrix-hacker-text-52.pages.dev/symbol/greek-psi-trident/)
- [SYM 1F607](https://vintage-library-rune-80.pages.dev/symbol/sym-1f607/)
- [SYM 2639](https://angelic-bow-symbols-42.pages.dev/symbol/sym-2639/)
- [SYM 267A](https://coquette-symbols.pages.dev/symbol/sym-267a/)
- [SYM 26A8](https://nordic-minimal-fonts-67.pages.dev/symbol/sym-26a8/)
- [SYM 1D499](https://gothic-bio-fonts-13.pages.dev/symbol/sym-1d499/)
- [SYM 26D7](https://angelic-bow-symbols-42.pages.dev/symbol/sym-26d7/)
- [SYM 263B](https://matrix-hacker-text-52.pages.dev/symbol/sym-263b/)
- [SYM 1FAE4](https://gothic-bio-fonts-13.pages.dev/symbol/sym-1fae4/)
- [SYM 1D493](https://gothic-bio-fonts-13.pages.dev/symbol/sym-1d493/)
- [SYM 26F8](https://nordic-minimal-fonts-67.pages.dev/symbol/sym-26f8/)
- [OUTLINED STAR](https://matrix-hacker-text-52.pages.dev/symbol/outlined-star/)
- [SYM 1D42D](https://theeduplaycampen.pages.dev/symbol/sym-1d42d/)
- [SYM 26DF](https://mecha-blade-symbols-46.pages.dev/symbol/sym-26df/)
- [SYM 1F62D](https://theeduplaycampen.pages.dev/symbol/sym-1f62d/)
- [SYM 26AC](https://coquette-symbols.pages.dev/symbol/sym-26ac/)
- [SYM 1D404](https://nordic-minimal-fonts-67.pages.dev/symbol/sym-1d404/)
- [STARRY ELEVATION AURA](https://angelic-bow-symbols-42.pages.dev/symbol/starry-elevation-aura/)
- [SYM 1D489](https://coquette-aesthetic-symbols-86.pages.dev/symbol/sym-1d489/)
- [SYM 26F5](https://angelic-bow-symbols-42.pages.dev/symbol/sym-26f5/)
- [GAMING WEAPONS](https://coquette-symbols.pages.dev/gaming-weapons/)
- [WHITE STAR](https://minimal-star-symbols-93.pages.dev/symbol/white-star/)
- [STARS](https://coquette-symbols.pages.dev/ja/stars/)
- [WHITE HEART](https://theeduplaycampen.pages.dev/symbol/white-heart/)
- [SYM 1D464](https://coquette-aesthetic-symbols-86.pages.dev/symbol/sym-1d464/)
- [SYM 1F911](https://matrix-hacker-text-52.pages.dev/symbol/sym-1f911/)
- [SYM 1D497](https://gothic-bio-fonts-13.pages.dev/symbol/sym-1d497/)
- [ANGEL WINGS HEART](https://theeduplaycampen.pages.dev/symbol/angel-wings-heart/)
- [SYM 2630](https://coquette-symbols.pages.dev/symbol/sym-2630/)
- [SYM 1D444](https://neon-glitch-symbols-84.pages.dev/symbol/sym-1d444/)
- [ROYAL GOLD CROWN](https://angelic-bow-symbols-42.pages.dev/symbol/royal-gold-crown/)
- [SYM 1F613](https://gothic-bio-fonts-13.pages.dev/symbol/sym-1f613/)
- [SYM 262B](https://matrix-hacker-text-52.pages.dev/symbol/sym-262b/)
- [SYM 1D429](https://nordic-minimal-fonts-67.pages.dev/symbol/sym-1d429/)
